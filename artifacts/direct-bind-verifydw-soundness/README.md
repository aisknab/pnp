...
It binds the historical `E` theorem-ledger row to current VerifyDW soundness, obligation-flattening, no-hidden-oracle, proof-obligation, and gap-ledger surfaces while rejecting public theorem activation, direct-binding completion overclaims, E row drift, missing no-hidden-oracle gap linkage, no-hidden-oracle audit overclaims, missing proof-obligation linkage, and missing status coordinate.
