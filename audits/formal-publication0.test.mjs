...
test('publication consumes the reviewed complete fourth-clause map and inventory counts', async () => {
  ...
  assert.equal(Object.keys(map.earnedMilestoneTheoremKernelTypeSha256).length, 1334);
