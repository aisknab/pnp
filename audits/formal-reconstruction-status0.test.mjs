...
test('formal reconstruction status accepts the current source and public mirrors', async () => {
  ...
  assert.equal(out.leanConcreteCookLevinBuilderArbitrarySlotHeaderRouterFormalized, true);
  assert.equal(out.leanConcreteCookLevinBuilderArbitrarySlotHeaderRouterAxiomAuditPassed, true);
  assert.equal(out.leanConcreteCookLevinBuilderArbitrarySlotHeaderRouterAuditedDeclarationCount, 51);
  assert.equal(out.leanConcreteCookLevinBuilderArbitrarySlotHeaderRouterLiteralRawMachineFormalized, true);
  assert.equal(out.leanConcreteCookLevinBuilderArbitrarySlotHeaderRouterExactRawTraceFormalized, true);
  assert.equal(out.leanConcreteCookLevinBuilderArbitrarySlotHeaderRouterExternalInputSizePolynomialFormalized, true);
  ...
  assert.equal(out.leanConcreteCookLevinBuilderPostHeaderRawDividerExactQuotientRemainderDecodeFormalized, true);
  assert.equal(out.leanConcreteCookLevinBuilderPostHeaderRawDividerExternalUnaryEncodedSizeQuadraticBoundFormalized, true);
  assert.equal(out.leanConcreteCookLevinBuilderPostHeaderRawDividerFailClosedBoundaryTimeoutFormalized, true);
  assert.equal(out.leanConcreteCookLevinBuilderPostHeaderRawDividerRawBodyTokenEmissionFormalized, false);
  assert.equal(out.leanConcreteCookLevinBuilderPostHeaderRawLaunchFormalized, true);
  assert.equal(out.leanConcreteCookLevinBuilderPostHeaderRawLaunchAxiomAuditPassed, true);
  assert.equal(out.leanConcreteCookLevinBuilderPostHeaderRawLaunchAuditedDeclarationCount, 24);
  assert.equal(out.leanConcreteCookLevinBuilderPostHeaderRawLaunchExactHandoffFormalized, true);
  assert.equal(out.leanConcreteCookLevinBuilderPostHeaderRawLaunchAllRoutesFormalized, true);
  ...
  for (const field of [
    ...
    'leanResidualTerminalProfileDependencySemanticsFormalized',
    'leanResidualTerminalProfileDependencySemanticsAxiomAuditPassed',
    'leanResidualTerminalProfileLocalityFormalized',
    'leanResidualTerminalProfileLocalityAxiomAuditPassed',
    'leanResidualTerminalSaturationTraceFidelityFormalized',
    'leanResidualTerminalSaturationTraceFidelityAxiomAuditPassed',
    'leanResidualTerminalPhysicalSaturationAccountingFormalized',
    'leanResidualTerminalPhysicalSaturationAccountingAxiomAuditPassed',
    'leanResidualTerminalPhysicalChargeLedgerFormalized',
    'leanResidualTerminalPhysicalChargeLedgerAxiomAuditPassed',
    'leanResidualTerminalSaturatedSupportContextFormalized',
    'leanResidualTerminalSaturatedSupportContextAxiomAuditPassed',
    'leanResidualTerminalPhysicalGainFormalized',
    'leanResidualTerminalPhysicalGainAxiomAuditPassed',
    'leanResidualTerminalGainProfileFirewallFormalized',
    'leanResidualTerminalGainProfileFirewallAxiomAuditPassed',
    'leanResidualIndependentMaterializerCostFormalized',
    'leanResidualIndependentMaterializerCostAxiomAuditPassed',
    'leanResidualTerminalPhysicalOwnershipFormalized',
    'leanResidualTerminalPhysicalOwnershipAxiomAuditPassed',
    'leanPCCMinConstructiveNANDSharingFormalized',
    'leanPCCMinConstructiveNANDSharingAxiomAuditPassed',
    'leanConcreteFinalReportBridgeFormalized',
    'leanConcreteFinalReportBridgeAxiomAuditPassed',
    'leanPCCMinOutputConePruningFormalized',
    'leanPCCMinOutputConePruningAxiomAuditPassed',
    'leanPCCMinDeadSupportContextFormalized',
    'leanPCCMinDeadSupportContextAxiomAuditPassed',
    'leanPCCMinDeadSupportFullModeFormalized',
    'leanPCCMinDeadSupportFullModeAxiomAuditPassed',
    'leanPCCMinConstantPropagationFormalized',
    'leanPCCMinConstantPropagationAxiomAuditPassed',
    'leanPCCMinPhysicalNormalizationClosureFormalized',
    'leanPCCMinPhysicalNormalizationClosureAxiomAuditPassed',
    'leanArbitrarySupportSpliceFormalized',
    'leanArbitrarySupportSpliceAxiomAuditPassed',
    'leanWireCarrierTransportFormalized',
    'leanWireCarrierTransportAxiomAuditPassed',
    'leanWireObligationRestorationFormalized',
    'leanWireObligationRestorationAxiomAuditPassed',
    'leanWireQuotientLiftFormalized',
    'leanWireQuotientLiftAxiomAuditPassed',
    'leanWireFrontierLiftFormalized',
    'leanWireFrontierLiftAxiomAuditPassed',
    'leanWireMatchedCancellationAxiomAuditPassed',
    'leanWireUnaryRealizationAxiomAuditPassed',
    'leanWireUnaryFrontierAxiomAuditPassed',
    'leanWireUnaryArbitrarySupportAxiomAuditPassed',
    'leanWireUnarySupportSearchAxiomAuditPassed',
    'leanWireZeroUnaryClosureAxiomAuditPassed',
    'leanSourceBoundedPhysicalBoundaryAxiomAuditPassed',
    'leanContextAwareSquareTransportAxiomAuditPassed',
    'leanWireCausalExpansionAxiomAuditPassed',
  ...
  assert.equal(
    out.leanResidualTerminalPacketNoLowerLedgerFormalized,
    true,
  );
  assert.equal(
    out.leanResidualTerminalPacketNoLowerLedgerAxiomAuditPassed,
    true,
  );
  assert.equal(
...
test('formal reconstruction status pins the locked-NAND carrier inventory and source closure', async () => {
  ...
  for (const command of [
    ...
    'node --test audits/lean-concrete-cook-levin-builder-post-header-raw-divider0.test.mjs',
    'lake env lean -DwarningAsError=true lean-audit/PNPConcreteCookLevinBuilderPostHeaderRawDividerAxiomAudit.lean',
    'lake env lean -DwarningAsError=true lean-regression/PNPConcreteCookLevinBuilderPostHeaderRawDivider.lean',
