...
const EXECUTABLE_PRIVATE_HELPERS = Object.freeze([
  ...
  'terminalSaturationTraceErase',
  'terminalSaturationTraceStep_erase',
  'terminalSaturationTraceStep_linked',
  'terminalSaturationTraceWork',
  'terminalSaturationTraceWork_erase',
  'terminalSaturationTraceWork_linked',
  'terminalSaturationTraceInitialState',
  'terminalSaturationTraceInitialState_erase',
  'terminalSaturationTraceFinalState',
  'terminalSaturationTraceFinalState_erase',
  'terminalSaturationTraceSeedRecords',
  'terminalSaturationTraceSeedRecords_append',
  'terminalSaturationTraceSeedRecords_generated',
  'terminalSaturationTraceSeedRecords_seed',
  'TerminalSaturationTraceWorkState.CostRecordsAccounted',
  'terminalSaturationTraceStep_costRecordsAccounted',
  'terminalSaturationTraceWork_costRecordsAccounted',
  'terminalSaturationTraceInitialState_costRecordsAccounted',
  'terminalSaturationTraceFinalState_costRecordsAccounted',
  'terminalSaturationTraceFinalState_pending_empty',
  'firstTerminalSaturationRule?_valid',
  'terminalFirstSaturationRule?_valid',
  'TerminalSaturationTracePending.RuleValid',
  'TerminalSaturationTraceWorkState.RulesValid',
  'terminalSaturationTraceStep_rulesValid',
