...
const CURRENT_PUBLIC_DECLARATIONS = Object.freeze([
  "PNP.DirectWire.terminalSelectedGateIndices",
  "PNP.DirectWire.terminalSelectedGates",
  ...
  "PNP.DirectWire.TerminalExtractedSupport",
  "PNP.DirectWire.extractTerminalSupport",
  ...
  "PNP.DirectWire.terminalExtractionGateIndex",
  "PNP.DirectWire.terminalExtractionOrigin",
  ...
  "PNP.DirectWire.terminalOpenGateEvaluation",
  "PNP.DirectWire.terminalOpenSupportSemantics",
  "PNP.DirectWire.TerminalSupportWire.candidateValue",
  "PNP.DirectWire.TerminalSupportWire.causalLevel",
  "PNP.DirectWire.terminalBoundaryCausalLabels",
  "PNP.DirectWire.terminalExtractedInterfaceCausalLevel",
  "PNP.DirectWire.extractTerminalSupport_causal_levels",
  "PNP.DirectWire.extractTerminalSupport_causal_index",
  "PNP.DirectWire.terminalInducedBoundaryValuation",
  ...
  "PNP.DirectWire.terminalBoundaryPullback",
...
const PRIVATE_HELPERS = Object.freeze([
  ...
  "boundaryInputSource_causal_bound",
  "Source.extractTerminal_causal_bound",
  "extractTerminalProgramAux",
  "TerminalExtractionOrigins",
  "extractTerminalOriginsAux",
  "extractTerminalProgramAux_causal_bound",
  "terminalExtractionState",
  "terminalInterfaceGet_selected",
  "terminalExtractedCandidate",
  "terminalExtractedInterfaceCausalLevel_le_caps",
