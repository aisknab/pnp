...
test('public theorem-emission gate accepts current denied status-bound non-activation state', async () => {
  ...
  assert.equal(out.statusBound, true);
  ...
  assert.equal(out.gateBindingRequiresFuturePR, false);
