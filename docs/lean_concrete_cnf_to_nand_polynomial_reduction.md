...
earned and three deliberately unearned. It pins 2,115 theorem types. Its
689,227 bytes have SHA-256
`1a7682523289d123a5673e42442ced6f11d8d2d001496447590719101de15338`.

Status coordinate
`PNP-FORMAL-RECONSTRUCTION-STATUS-2026-08-03-97`, paired with
public-surface coordinate
`PUBLIC-SURFACE-BASELINE-2026-08-03-RESIDUAL-TERMINAL-FULL-CARRIER-BRIDGE-96`,
records this reduction boundary as earned. Its 1,693,893 bytes have SHA-256
...
and a deterministic 71-page, 424,881-byte A4 PDF with SHA-256
