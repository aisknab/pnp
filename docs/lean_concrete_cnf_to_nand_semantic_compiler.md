...
earned and two deliberately unearned. It pins 2,577 theorem types; its
836,589 bytes have SHA-256
...
records this semantic boundary as earned. Its 2,101,076 bytes have SHA-256
