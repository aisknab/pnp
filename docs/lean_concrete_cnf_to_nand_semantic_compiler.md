...
earned and two deliberately unearned. It pins 2,530 theorem types; its
820,122 bytes have SHA-256
...
records this semantic boundary as earned. Its 2,060,926 bytes have SHA-256
