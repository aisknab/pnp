...
earned and three deliberately unearned. It pins 2,219 theorem types; its
720,540 bytes have SHA-256
...
records this semantic boundary as earned. Its 1,780,999 bytes have SHA-256
