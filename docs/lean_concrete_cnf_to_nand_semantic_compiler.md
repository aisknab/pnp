...
earned and three deliberately unearned. It pins 2,263 theorem types; its
733,234 bytes have SHA-256
...
records this semantic boundary as earned. Its 1,816,951 bytes have SHA-256
