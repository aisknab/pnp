...
earned and three deliberately unearned. It pins 2,432 theorem types; its
788,580 bytes have SHA-256
...
records this semantic boundary as earned. Its 1,983,101 bytes have SHA-256
