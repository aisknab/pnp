...
candidates. The canonical inventory is 17,400,943 bytes with SHA-256
...
contains 2,511 theorem types. The map is 813,470 bytes with SHA-256
`3385b374bdbc737e8c6808698dc0284ad84ac0850d7bd62b7079d5f6d5b2cfed`.

Status coordinate
`PNP-FORMAL-RECONSTRUCTION-STATUS-2026-08-11-125` records the semantic
...
false concrete publication gate. The status is 2,044,745 bytes with SHA-256
...
and an 83-page, 450,819-byte PDF with SHA-256
