...
candidates. The canonical inventory is 15,824,195 bytes with SHA-256
...
contains 2,352 theorem types. The map is 761,711 bytes with SHA-256
`8404f2c2b178d87c42f4501b4490286c90da593281dad2708297c22b0fbfa9df`.

Status coordinate
`PNP-FORMAL-RECONSTRUCTION-STATUS-2026-08-08-112` records the semantic
...
false concrete publication gate. The status is 1,901,511 bytes with SHA-256
...
and a 77-page, 437,284-byte PDF with SHA-256
