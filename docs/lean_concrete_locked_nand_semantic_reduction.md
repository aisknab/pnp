...
candidates. The canonical inventory is 15,930,331 bytes with SHA-256
...
contains 2,364 theorem types. The map is 766,476 bytes with SHA-256
`6d05c3a4d70ea78994a0302a60c8ba8381e37ff4e9c30a774ab474a13bb9baac`.

Status coordinate
`PNP-FORMAL-RECONSTRUCTION-STATUS-2026-08-08-113` records the semantic
...
false concrete publication gate. The status is 1,916,515 bytes with SHA-256
...
and a 78-page, 438,997-byte PDF with SHA-256
