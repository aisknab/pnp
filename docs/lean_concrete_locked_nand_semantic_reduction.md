...
candidates. The canonical inventory is 17,124,322 bytes with SHA-256
...
contains 2,468 theorem types. The map is 800,452 bytes with SHA-256
`a36c1099429ae6d1b8d89cba1f40a2f71e3489d919d07770f6a3fca7624d23dc`.

Status coordinate
`PNP-FORMAL-RECONSTRUCTION-STATUS-2026-08-10-120` records the semantic
...
false concrete publication gate. The status is 2,013,081 bytes with SHA-256
...
and an 81-page, 445,928-byte PDF with SHA-256
