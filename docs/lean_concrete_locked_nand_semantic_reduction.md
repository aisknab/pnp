...
candidates. The canonical inventory is 14,824,236 bytes with SHA-256
...
contains 2,263 theorem types. The map is 733,234 bytes with SHA-256
`84fe388d393239530a12a76cf14a262c1fdf35e2e1089ced0e90e981aa1c8f09`.

Status coordinate
`PNP-FORMAL-RECONSTRUCTION-STATUS-2026-08-06-107` records the semantic
...
false concrete publication gate. The status is 1,816,951 bytes with SHA-256
...
and a 76-page, 434,167-byte PDF with SHA-256
