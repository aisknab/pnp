...
candidates. The canonical inventory is 15,014,491 bytes with SHA-256
...
contains 2,299 theorem types. The map is 744,575 bytes with SHA-256
`b628ea8684a56e748da90d753b054cce50428af9d213ff8928d0492b82f9cd1f`.

Status coordinate
`PNP-FORMAL-RECONSTRUCTION-STATUS-2026-08-07-109` records the semantic
...
false concrete publication gate. The status is 1,849,193 bytes with SHA-256
...
and a 76-page, 435,428-byte PDF with SHA-256
