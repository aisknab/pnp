...
candidates. The canonical inventory is 16,265,958 bytes with SHA-256
...
contains 2,397 theorem types. The map is 777,623 bytes with SHA-256
`9e688aae5553d680b6ff1f8fea8587f121edaf76c55efef110909f0d08173af8`.

Status coordinate
`PNP-FORMAL-RECONSTRUCTION-STATUS-2026-08-09-115` records the semantic
...
false concrete publication gate. The status is 1,949,873 bytes with SHA-256
...
and a 79-page, 440,948-byte PDF with SHA-256
