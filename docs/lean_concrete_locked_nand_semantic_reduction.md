...
candidates. The canonical inventory is 13,833,685 bytes with SHA-256
...
contains 2,166 theorem types. The map is 704,920 bytes with SHA-256
`89fbdf1ba505549c8f2f0db99bdc4b6a53895c2a65b094415c7d03dfb0601c4c`.

Status coordinate
`PNP-FORMAL-RECONSTRUCTION-STATUS-2026-08-05-102` records the semantic
...
false concrete publication gate. The status is 1,735,904 bytes with SHA-256
...
and a 73-page, 429,037-byte PDF with SHA-256
