...
candidates. The canonical inventory is 13,748,432 bytes with SHA-256
...
contains 2,152 theorem types. The map is 701,078 bytes with SHA-256
`a86df7f8d45a5430bc1b7cc67dfac31e8663a9e81ed24abc0f25a2cd299b0b7c`.

Status coordinate
`PNP-FORMAL-RECONSTRUCTION-STATUS-2026-08-04-101` records the semantic
...
false concrete publication gate. The status is 1,725,364 bytes with SHA-256
...
and a 73-page, 428,831-byte PDF with SHA-256
