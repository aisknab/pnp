...
candidates. The canonical inventory is 16,124,474 bytes with SHA-256
...
contains 2,385 theorem types. The map is 773,039 bytes with SHA-256
`5ee8bb52412e04ce7b5ba9bccb619070d0963df00044f8f26b2bfe0aef73d186`.

Status coordinate
`PNP-FORMAL-RECONSTRUCTION-STATUS-2026-08-08-114` records the semantic
...
false concrete publication gate. The status is 1,935,171 bytes with SHA-256
...
and a 78-page, 439,981-byte PDF with SHA-256
