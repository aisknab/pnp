...
candidates. The canonical inventory is 13,945,316 bytes with SHA-256
...
contains 2,183 theorem types. The map is 709,628 bytes with SHA-256
`da4a437c935e7c5072b09534669305d6876ac7d9b375cef34a08d9dbb4390480`.

Status coordinate
`PNP-FORMAL-RECONSTRUCTION-STATUS-2026-08-05-103` records the semantic
...
false concrete publication gate. The status is 1,749,669 bytes with SHA-256
...
and a 74-page, 430,495-byte PDF with SHA-256
