...
candidates. The canonical inventory is 13,432,952 bytes with SHA-256
...
contains 2,093 theorem types. The map is 682,067 bytes with SHA-256
`66f06c9891f0f60236ba2742f5965ac94813bb08b4cf722ff021ac8a37ea9fb1`.

Status coordinate
`PNP-FORMAL-RECONSTRUCTION-STATUS-2026-08-03-95` records the semantic
...
false concrete publication gate. The status is 1,675,872 bytes with SHA-256
...
and a 69-page, 420,680-byte PDF with SHA-256
