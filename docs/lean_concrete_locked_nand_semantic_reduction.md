...
The canonical generated inventory, publication map, status payload, and
report artifacts supply current coordinates, counts, source fingerprints,
sizes, and hashes. The encoded-semantic-boundary milestone pins eleven
reviewed theorem types.
