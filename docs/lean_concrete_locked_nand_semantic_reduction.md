...
candidates. The canonical inventory is 16,596,402 bytes with SHA-256
...
contains 2,426 theorem types. The map is 785,551 bytes with SHA-256
`24c3ad1302faa4e5e375911eaaebe7b3b42ef4fbd9ee3b6e1bf5ebdd5d7d4bff`.

Status coordinate
`PNP-FORMAL-RECONSTRUCTION-STATUS-2026-08-09-116` records the semantic
...
false concrete publication gate. The status is 1,973,518 bytes with SHA-256
...
and a 79-page, 441,656-byte PDF with SHA-256
