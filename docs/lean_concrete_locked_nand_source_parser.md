...
`PNP-FORMAL-PUBLICATION-MAP-2026-08-03-95` contains 75 milestones, of
which 72 are earned and three global milestones remain unearned. The map pins
2,093 theorem types. Its 682,067 bytes have SHA-256
...
coordinate
`PUBLIC-SURFACE-BASELINE-2026-08-03-RESIDUAL-GAIN-CHAIN-BOUND-94`, records
...
publication gate. The status is 1,675,872 bytes with SHA-256
...
`PNP-CANONICAL-FORMAL-RECONSTRUCTION-REPORT-2026-08-03-95` renders as a
69-page A4 PDF. The generated TeX is 177,190 bytes with SHA-256
`b13f970372569e2559a0c2f60188420210ffccdc9653e5ee04f36cf57d6ce835`;
the deterministic PDF is 420,680 bytes with SHA-256
