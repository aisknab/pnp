...
`PNP-FORMAL-PUBLICATION-MAP-2026-08-07-110` contains 90 milestones, of
which 87 are earned and three global milestones remain unearned. The map pins
2,316 theorem types. Its 750,275 bytes have SHA-256
...
coordinate
`PUBLIC-SURFACE-BASELINE-2026-08-07-RESIDUAL-TERMINAL-FOUR-CORNER-CARRIER-109`, records
...
publication gate. The status is 1,867,836 bytes with SHA-256
...
`PNP-CANONICAL-FORMAL-RECONSTRUCTION-REPORT-2026-08-07-110` renders as a
77-page A4 PDF. The generated TeX is 195,614 bytes with SHA-256
`51e174f1cbff5030a905ce6e791741a0f69facb1500acfad3b6b1c72ccdea641`;
the deterministic PDF is 436,374 bytes with SHA-256
