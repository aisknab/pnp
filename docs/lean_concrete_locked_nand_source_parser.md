...
`PNP-FORMAL-PUBLICATION-MAP-2026-08-12-132` contains 110 milestones, of
which 107 are earned and two global milestones remain unearned. The map pins
...
publication gate. The status is 2,101,076 bytes with SHA-256
...
`PNP-CANONICAL-FORMAL-RECONSTRUCTION-REPORT-2026-08-12-132` renders as an
87-page A4 PDF. The generated TeX is 221,513 bytes with SHA-256
`df8ff9aa32c8edc76d9d8f5ba07fbb3bd80fa8435bd3cea28d572d7371cc8e59`;
the deterministic PDF is 458,350 bytes with SHA-256
