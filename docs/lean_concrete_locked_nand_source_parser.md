...
`PNP-FORMAL-PUBLICATION-MAP-2026-08-10-119` contains 99 milestones, of
which 96 are earned and three global milestones remain unearned. The map pins
2,459 theorem types. Its 797,067 bytes have SHA-256
...
coordinate
`PUBLIC-SURFACE-BASELINE-2026-08-10-INTERFACE-EXPOSURE-ROUTING-118`, records
...
publication gate. The status is 2,004,368 bytes with SHA-256
...
`PNP-CANONICAL-FORMAL-RECONSTRUCTION-REPORT-2026-08-10-119` renders as an
81-page A4 PDF. The generated TeX is 206,457 bytes with SHA-256
`9293f165e378e9d196e7725a8a895f7a2d4c09b543ba3143ba7d34055b2d236a`;
the deterministic PDF is 444,907 bytes with SHA-256
