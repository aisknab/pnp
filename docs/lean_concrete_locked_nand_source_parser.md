...
publication gate. The status is 2,024,772 bytes with SHA-256
...
`PNP-CANONICAL-FORMAL-RECONSTRUCTION-REPORT-2026-08-10-122` renders as an
82-page A4 PDF. The generated TeX is 209,712 bytes with SHA-256
`924606c880420091e8aff17f185ea52e8080c7729c3a1fba520f678e848be83a`;
the deterministic PDF is 447,683 bytes with SHA-256
