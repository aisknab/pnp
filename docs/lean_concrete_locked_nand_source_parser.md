...
`PNP-FORMAL-PUBLICATION-MAP-2026-08-04-100` contains 80 milestones, of
which 77 are earned and three global milestones remain unearned. The map pins
2,145 theorem types. Its 698,849 bytes have SHA-256
...
coordinate
`PUBLIC-SURFACE-BASELINE-2026-08-04-RESIDUAL-TERMINAL-PROJECTION-TRANSFER-99`, records
...
publication gate. The status is 1,718,803 bytes with SHA-256
...
`PNP-CANONICAL-FORMAL-RECONSTRUCTION-REPORT-2026-08-04-100` renders as a
72-page A4 PDF. The generated TeX is 184,334 bytes with SHA-256
`4b1f709d9bc591832962253a3bc52bec0d8548ea0b0da4a745f4602d04c27aae`;
the deterministic PDF is 427,894 bytes with SHA-256
