...
`PNP-FORMAL-PUBLICATION-MAP-2026-08-12-131` contains 109 milestones, of
...
publication gate. The status is 2,092,488 bytes with SHA-256
...
`PNP-CANONICAL-FORMAL-RECONSTRUCTION-REPORT-2026-08-12-131` renders as an
87-page A4 PDF. The generated TeX is 220,107 bytes with SHA-256
`11e852d3d9049417f15824033595d560a145adcf62fea7e745d731c025afcfd6`;
the deterministic PDF is 457,490 bytes with SHA-256
