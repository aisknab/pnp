...
The strict composition is not yet registered as the repository's
source-to-target `PolynomialReduction`. That next packaging step must bind the
already-proved encoded language equivalence to this exact compiled function.
The abstract `PNP.LockedNANDThreshold` assumption, CNFSAT-in-P transport,
NP-hardness transport, and `PNP.Main.p_eq_np` remain outside this milestone.
...
- publication map:
  `PNP-FORMAL-PUBLICATION-MAP-2026-07-29-91`
- reconstruction status:
  `PNP-FORMAL-RECONSTRUCTION-STATUS-2026-07-29-91`
- public surface:
  `PUBLIC-SURFACE-BASELINE-2026-07-29-LOCKED-NAND-TARGET-EMITTER-90`
- canonical report:
  `PNP-CANONICAL-FORMAL-RECONSTRUCTION-REPORT-2026-07-29-91`

The compiled inventory records 20,957 declarations, 11,424 theorems, 5,968
assumption-free theorems, 11,692 excluded private declarations, 184
source-closure modules, and 2,030 reviewed milestone candidates. Its
12,883,572 canonical bytes have SHA-256
...
The 664,137-byte publication map contains 71 milestones: 68 earned and three
deliberately unearned. It pins 2,030 theorem types and has SHA-256
`e77c95963004c3e170eebb3984df15ac73530243c76fe23cb424fb3b0c722726`.
The generated 1,628,650-byte status has SHA-256
`e246e54524b5ef8d6a94a33ebe0888020e607be90e49362df33222d792a9e929`.
The canonical 167,716-byte TeX source has SHA-256
`49c9df4b981fa87b378fac3ac5b70b257c3fac1166732f9221478fcdf30fbe58`;
its deterministic 65-page, 411,556-byte A4 PDF has SHA-256
