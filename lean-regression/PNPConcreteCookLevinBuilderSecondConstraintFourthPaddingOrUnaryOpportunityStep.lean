...
namespace PNP.Concrete.CookLevinBuilderSecondConstraintFourthPaddingOrUnaryOpportunityStepRegression

open PipelineTape PipelineStateNamespace
open CookLevin
open CookLevin.BuilderSecondConstraintFourthPaddingOrUnaryOpportunityStep
...
example : finalTokenSlot (inputOnlyProblem []) = 4519 := rfl
example : finalTokenSlot (inputOnlyProblem [false]) = 22227 := rfl
example : finalTokenSlot (inputOnlyProblem [true]) = 22227 := rfl
example : finalTokenSlot
    (inputOnlyProblem [true, false, true]) = 167275 := rfl
example : finalTokenSlot
    (pairedProblem [true, false, true]) = 41459455 := rfl
example : finalTokenSlot
    (inputOnlyProblem [false, false, false, false]) = 344535 := rfl
example : finalTokenSlot
    (inputOnlyProblem [true, true, true, true]) = 344535 := rfl

example (input : BitString) :
    secondConstraintFourthPaddingOrUnaryTokens (inputOnlyProblem input) =
...
example (input : BitString) :
    ∃ rest, encodeCNFTokens (inputOnlyProblem input).formula =
      secondConstraintFourthPaddingOrUnaryTokens
...
end PNP.Concrete.CookLevinBuilderSecondConstraintFourthPaddingOrUnaryOpportunityStepRegression
