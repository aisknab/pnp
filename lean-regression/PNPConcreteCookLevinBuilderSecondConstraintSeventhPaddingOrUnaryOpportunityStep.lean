...
namespace PNP.Concrete.CookLevinBuilderSecondConstraintSeventhPaddingOrUnaryOpportunityStepRegression

open PipelineTape PipelineStateNamespace
open CookLevin
open CookLevin.BuilderSecondConstraintSeventhPaddingOrUnaryOpportunityStep
...
example : finalTokenSlot (inputOnlyProblem []) = 4522 := rfl
example : finalTokenSlot (inputOnlyProblem [false]) = 22230 := rfl
example : finalTokenSlot (inputOnlyProblem [true]) = 22230 := rfl
example : finalTokenSlot
    (inputOnlyProblem [true, false, true]) = 167278 := rfl
example : finalTokenSlot
    (pairedProblem [true, false, true]) = 41459458 := rfl
example : finalTokenSlot
    (inputOnlyProblem [false, false, false, false]) = 344538 := rfl
example : finalTokenSlot
    (inputOnlyProblem [true, true, true, true]) = 344538 := rfl

example (input : BitString) :
    secondConstraintSeventhPaddingOrUnaryTokens (inputOnlyProblem input) =
...
example (input : BitString) :
    ∃ rest, encodeCNFTokens (inputOnlyProblem input).formula =
      secondConstraintSeventhPaddingOrUnaryTokens
...
end PNP.Concrete.CookLevinBuilderSecondConstraintSeventhPaddingOrUnaryOpportunityStepRegression
