...
namespace PNP.Concrete.CookLevinBuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStepRegression

open PipelineTape PipelineStateNamespace
open CookLevin
open CookLevin.BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep
...
example : finalTokenSlot (inputOnlyProblem []) = 4521 := rfl
example : finalTokenSlot (inputOnlyProblem [false]) = 22229 := rfl
example : finalTokenSlot (inputOnlyProblem [true]) = 22229 := rfl
example : finalTokenSlot
    (inputOnlyProblem [true, false, true]) = 167277 := rfl
example : finalTokenSlot
    (pairedProblem [true, false, true]) = 41459457 := rfl
example : finalTokenSlot
    (inputOnlyProblem [false, false, false, false]) = 344537 := rfl
example : finalTokenSlot
    (inputOnlyProblem [true, true, true, true]) = 344537 := rfl

example (input : BitString) :
    secondConstraintSixthPaddingOrOpeningUnaryTokens (inputOnlyProblem input) =
...
example (input : BitString) :
    ∃ rest, encodeCNFTokens (inputOnlyProblem input).formula =
      secondConstraintSixthPaddingOrOpeningUnaryTokens
...
end PNP.Concrete.CookLevinBuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStepRegression
