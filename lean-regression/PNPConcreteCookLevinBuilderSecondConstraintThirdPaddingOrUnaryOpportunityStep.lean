...
namespace PNP.Concrete.CookLevinBuilderSecondConstraintThirdPaddingOrUnaryOpportunityStepRegression

open PipelineTape PipelineStateNamespace
open CookLevin
open CookLevin.BuilderSecondConstraintThirdPaddingOrUnaryOpportunityStep
...
example : finalTokenSlot (inputOnlyProblem []) = 4518 := rfl
example : finalTokenSlot (inputOnlyProblem [false]) = 22226 := rfl
example : finalTokenSlot (inputOnlyProblem [true]) = 22226 := rfl
example : finalTokenSlot
    (inputOnlyProblem [true, false, true]) = 167274 := rfl
example : finalTokenSlot
    (pairedProblem [true, false, true]) = 41459454 := rfl
example : finalTokenSlot
    (inputOnlyProblem [false, false, false, false]) = 344534 := rfl
example : finalTokenSlot
    (inputOnlyProblem [true, true, true, true]) = 344534 := rfl

example (input : BitString) :
    secondConstraintThirdPaddingOrUnaryTokens (inputOnlyProblem input) =
...
example (input : BitString) :
    ∃ rest, encodeCNFTokens (inputOnlyProblem input).formula =
      secondConstraintThirdPaddingOrUnaryTokens
...
end PNP.Concrete.CookLevinBuilderSecondConstraintThirdPaddingOrUnaryOpportunityStepRegression
