...
namespace PacketExactRouteReflectionRegression
...
example :
    (forgedRoutePayload.withComputedExactRouteRankDescent 0 beforeRank
...
example :
  ...
  forgedRoutePayload.withComputedExactRouteRankDescent_firstRoute_ne_some_rank
    0 beforeRank beforeRank

example :
    (forgedRoutePayload.withComputedExactRouteRankDescent 0 beforeRank
      beforeRank).firstRoute 0 ≠ some .exactRoute :=
  forgedRoutePayload.withComputedExactRouteRankDescent_firstRoute_ne_some_exactRoute
      0 beforeRank beforeRank
...
example :
  ...
  intro routeFailure
  exact ((forgedRoutePayload.withComputedExactRouteRankDescent_failureAt_exactRoute_iff_false
...
example :
    (colourFailurePayload.withComputedExactRouteRankDescent 0 beforeRank
      smallerAfterRank).firstRoute 0 = some .colour := by
  rfl

example :
    (frontierFailurePayload.withComputedExactRouteRankDescent 0 beforeRank
      smallerAfterRank).firstRoute 0 = some .frontier := by
  rfl

example :
    (chargeFailurePayload.withComputedExactRouteRankDescent 0 beforeRank
      smallerAfterRank).firstRoute 0 = some .charge := by
  rfl

example :
    (obligationFailurePayload.withComputedExactRouteRankDescent 0 beforeRank
      smallerAfterRank).firstRoute 0 = some .obligation := by
  rfl

example :
    (activationFailurePayload.withComputedExactRouteRankDescent 0 beforeRank
      smallerAfterRank).firstRoute 0 = some .activation := by
  rfl

example :
    (directionFailurePayload.withComputedExactRouteRankDescent 0 beforeRank
      smallerAfterRank).firstRoute 0 = some .direction := by
  rfl

example :
    (budgetFailurePayload.withComputedExactRouteRankDescent 0 beforeRank
      smallerAfterRank).firstRoute 0 = some .budget := by
  rfl

example : smallerAfterRank.LexLT beforeRank := by
  apply forgedRoutePayload.rankDescent_of_withComputedExactRouteRankDescent_check
...
example
  ...
  family.computedExactRouteRankDescent_firstRoute_ne_some_rank rankOf before
    after handle
...
example
  ...
  family.computedExactRouteRankDescent_firstRoute_ne_some_exactRoute rankOf
    before after handle
...
example
  ...
  terminalBN6_packet_exact_route_reflected_hb_first_route_failure conclusion
    table dependencyTable before after silenceAccepted closureAccepted

end PacketExactRouteReflectionRegression
end DirectWire
end PNP
