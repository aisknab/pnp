...
The second width-dependent padding-or-unary opportunity after the first
...
second unary unit.  Both branches then materialize the following formula
...
process the following padding or third unary token, complete the second
...
namespace BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep
...
theorem opportunitySlot_eq_secondConstraintStart_add_nine
  ...
  change
    BuilderSecondConstraintPaddingOrUnaryOpportunityStep.opportunitySlot
        problem +
      1 = _
  rw [
    BuilderSecondConstraintPaddingOrUnaryOpportunityStep.opportunitySlot_eq_secondConstraintStart_add_eight]
...
def machine {language : Language}
    (problem : VerifierTableauProblem language) : WorkMachine :=
  BuilderFirstClausePrefix.WorkChain.machine
    (BuilderSecondConstraintPaddingOrUnaryOpportunityStep.machine problem)
...
private theorem predecessor_noRuleAtAccept {language : Language}
    ...
    BuilderFirstClausePrefix.WorkChain.NoRuleAtAccept
      (BuilderSecondConstraintPaddingOrUnaryOpportunityStep.machine problem) := by
  exact
    BuilderSecondConstraintPaddingOrUnaryOpportunityStep.rule_source_ne_acceptState
      problem
...
theorem rules_length {language : Language}
  ...
  have hPredecessor :=
    BuilderSecondConstraintPaddingOrUnaryOpportunityStep.rules_length problem
...
theorem rules_pairwise_query_distinct {language : Language}
  ...
  exact BuilderFirstClausePrefix.WorkChain.rules_pairwise_query_distinct
    (BuilderSecondConstraintPaddingOrUnaryOpportunityStep.machine problem)
    (suffixMachine problem)
    (BuilderSecondConstraintPaddingOrUnaryOpportunityStep.rules_pairwise_query_distinct
      problem)
...
def secondConstraintSecondPaddingOrUnaryTokens {language : Language}
    (problem : VerifierTableauProblem language) : List CNFToken :=
...
def widthOutside {language : Language}
  ...
  BuilderUnaryPolynomial.finalOutsideLeft
    ...
    (BuilderSecondConstraintPaddingOrUnaryOpportunityStep.finalOutside problem)
...
def controllerFinalOutside {language : Language}
  ...
  (widthWord problem).take (widthRootPrefixLength problem) ++
    ...
    [BuilderUnaryPolynomial.scratchEndSymbol,
     BuilderUnaryPolynomial.scratchEndSymbol] ++
    (BuilderSecondConstraintPaddingOrUnaryOpportunityStep.finalOutside problem).drop
...
def branchFinalTape {language : Language}
  ...
  BuilderTokenAppender.workspaceTape problem.input
    ...
    (secondConstraintSecondPaddingOrUnaryTokens problem)
...
def workSteps {language : Language}
    (problem : VerifierTableauProblem language) : Nat :=
  BuilderSecondConstraintPaddingOrUnaryOpportunityStep.workSteps problem + 1 +
...
theorem widthEvaluator_workRunExact {language : Language}
    ...
    workRunExact? (widthEvaluator problem) (widthWorkSteps problem)
        (BuilderUnaryPolynomial.initialConfiguration
          (widthPolynomial problem) problem.input
          (BuilderSecondConstraintPaddingOrUnaryOpportunityStep.finalOutside
            problem)
          (BuilderSecondConstraintPaddingOrUnaryOpportunityStep.secondConstraintPaddingOrUnaryTokens
            problem)) =
      some
  ...
  | succ remaining =>
      ...
      | zero =>
          ...
          simpa [hBranchWorkSteps, controllerWorkSteps,
            ...
            secondConstraintSecondPaddingOrUnaryTokens, hOpportunityOutput,
    ...
    workRunExact? (targetEvaluator problem) (targetWorkSteps problem)
      ...
      some
        (BuilderUnaryPolynomial.finalConfiguration
          (opportunitySlotPolynomial problem.verifier) problem.input
          (controllerFinalOutside problem)
          (secondConstraintSecondPaddingOrUnaryTokens problem)) := by
  exact BuilderUnaryPolynomial.workRunExact
    (opportunitySlotPolynomial problem.verifier) problem.input
    (controllerFinalOutside problem)
    (secondConstraintSecondPaddingOrUnaryTokens problem)
...
private theorem widthBranch_workRunExact {language : Language}
    ...
    workRunExact? (widthBranchMachine problem)
        ...
        (workStartConfiguration (widthBranchMachine problem)
          (BuilderSecondConstraintPaddingOrUnaryOpportunityStep.finalTape
            problem)) =
      some
...
theorem suffix_workRunExact {language : Language}
  ...
  let widthBranchInitial := workStartConfiguration
    ...
    (BuilderSecondConstraintPaddingOrUnaryOpportunityStep.finalTape problem)
...
theorem prefix_workRunExact {language : Language}
    ...
    workRunExact? (machine problem)
        (BuilderSecondConstraintPaddingOrUnaryOpportunityStep.workSteps problem)
      ...
      some
        (renameConfiguration
          ...
          (BuilderSecondConstraintPaddingOrUnaryOpportunityStep.finalConfiguration
            problem)) := by
  ...
  have hRun := hTransport
    ...
    (BuilderSecondConstraintPaddingOrUnaryOpportunityStep.finalConfiguration
      problem)
    (BuilderSecondConstraintPaddingOrUnaryOpportunityStep.workRunExact problem)
  exact hRun
...
theorem workRunExact {language : Language}
  ...
  let prefixInitial := workStartConfiguration
    ...
    (rawInputWorkTape problem.input)
  let prefixFinal :=
    BuilderSecondConstraintPaddingOrUnaryOpportunityStep.finalConfiguration problem
...
theorem specification_opportunity_step {language : Language}
    ...
    VerifierTableauProblem.FormulaTokenCursor.step problem
        ⟨BuilderSecondConstraintPaddingOrUnaryOpportunityStep.finalTokenSlot
          problem⟩ =
      some ((if problem.dimensions.tapeWidth problem.tableauInputMode = 1
        ...
        ⟨BuilderSecondConstraintPaddingOrUnaryOpportunityStep.finalTokenSlot
          problem + 1⟩) := by
  exact
    BuilderSecondConstraintPaddingOrUnaryOpportunityStep.specification_following_step
      problem

/-- The finite output is exactly the canonical token prefix after consuming
the second width-selected padding-or-unary opportunity. -/
theorem secondConstraintSecondPaddingOrUnaryTokens_eq_canonical_formula_prefix
    {language : Language} (problem : VerifierTableauProblem language) :
    ∃ rest, encodeCNFTokens problem.formula =
      secondConstraintSecondPaddingOrUnaryTokens problem ++ rest := by
  rcases
      BuilderSecondConstraintFirstLiteralTerminatorStep.encodeCNFTokens_eq_terminator_then_successor_and_two_optional_unary
        problem with
    ⟨rest, hTokens⟩
  refine ⟨rest, ?_⟩
  unfold secondConstraintSecondPaddingOrUnaryTokens
    BuilderSecondConstraintPaddingOrUnaryOpportunityStep.secondConstraintPaddingOrUnaryTokens
...
theorem finalTokenSlot_eq_predecessor_add_one {language : Language}
  (problem : VerifierTableauProblem language) :
    finalTokenSlot problem =
      BuilderSecondConstraintPaddingOrUnaryOpportunityStep.finalTokenSlot problem +
        1 := by
  rw [finalTokenSlot, opportunitySlot_eq_secondConstraintStart_add_nine,
    BuilderSecondConstraintPaddingOrUnaryOpportunityStep.finalTokenSlot_eq_secondConstraintStart_add_eight]

theorem finalTokenSlot_eq_secondConstraintStart_add_nine
    {language : Language} (problem : VerifierTableauProblem language) :
    finalTokenSlot problem =
      problem.formulaVariableSlotBound + 1 +
        problem.formulaClauseSlotsPerConstraint *
          problem.formulaTokensPerClause + 9 := by
  exact opportunitySlot_eq_secondConstraintStart_add_nine problem

/-- The retained coordinate identifies the opportunity after the processed
slot: another padding opportunity at width one, otherwise the third unary
...
theorem followingTokenSlot_direct_eq_padding_or_t {language : Language}
  ...
  have hFollowing :=
    BuilderSecondConstraintFirstLiteralTerminatorStep.thirdFollowingTokenSlot_direct_eq_padding_or_t
      problem
...
def rawTimeBound {language : Language}
  ...
  .add
    (BuilderSecondConstraintPaddingOrUnaryOpportunityStep.rawTimeBound verifier)
    (.add (.constant 624)
...
after the second width-selected padding-or-unary opportunity. -/
theorem finalTokenBits_eq_encodedFormula_secondConstraintSecondPaddingOrUnary
    {language : Language} (problem : VerifierTableauProblem language) :
    encodeTokenPairs (secondConstraintSecondPaddingOrUnaryTokens problem) =
  ...
  have hLength :
      (encodeTokenPairs
        (secondConstraintSecondPaddingOrUnaryTokens problem)).length =
        2 * (problem.FormulaWidth + 43 +
          if problem.dimensions.tapeWidth problem.tableauInputMode = 1
            then 0 else 2) := by
    rw [encodeTokenPairs_length,
      secondConstraintSecondPaddingOrUnaryTokens, List.length_append,
...
private theorem appenderWorkSteps_le {language : Language}
    ...
    appenderWorkSteps problem ≤
      4 * problem.input.length + 2 * problem.FormulaWidth + 96 := by
...
theorem rawTimeBound_eval {language : Language}
    ...
    (rawTimeBound problem.verifier).eval problem.input.length =
      ...
      624 + 24 * problem.input.length + 12 * problem.FormulaWidth +
...
theorem rawTimeBound_le {language : Language}
  ...
  have hPrefix :=
    BuilderSecondConstraintPaddingOrUnaryOpportunityStep.rawTimeBound_le problem
...
end BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep
