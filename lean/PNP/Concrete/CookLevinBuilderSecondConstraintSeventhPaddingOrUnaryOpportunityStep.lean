...
The seventh width-dependent padding-or-token opportunity after the first
...
already-audited token appender at its `T` state and emits the first
unary-index token of the following positive literal.  Both branches then
materialize the following formula coordinate.  No host-side schedule lookup
or caller-supplied branch certificate is used.

This processes exactly one additional schedule opportunity.  It does not
process the following padding or second unary-index `T`, complete the
following literal, traverse the second constraint, implement a general
schedule cursor, complete the formula builder, or establish P = NP.
-/
...
namespace BuilderSecondConstraintSeventhPaddingOrUnaryOpportunityStep
...
def opportunitySlotPolynomial {language : Language}
  ...
  .add
    (BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.opportunitySlotPolynomial
      verifier)
    (.constant 1)
...
theorem opportunitySlot_eq_secondConstraintStart_add_fourteen
  ...
  change
    BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.opportunitySlot
        problem +
      1 = _
  rw [
    BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.opportunitySlot_eq_secondConstraintStart_add_thirteen]
...
def machine {language : Language}
    (problem : VerifierTableauProblem language) : WorkMachine :=
  BuilderFirstClausePrefix.WorkChain.machine
    (BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.machine problem)
...
private theorem predecessor_noRuleAtAccept {language : Language}
    ...
    BuilderFirstClausePrefix.WorkChain.NoRuleAtAccept
      (BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.machine problem) := by
  exact
    BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.rule_source_ne_acceptState
      problem
...
theorem rules_length {language : Language}
      ...
      6124 +
        ...
        BuilderUnaryPolynomial.ruleCount
          (BuilderSecondConstraintFifthPaddingOrTerminatorOpportunityStep.widthPolynomial
            problem) +
        BuilderUnaryPolynomial.ruleCount
          (BuilderSecondConstraintFifthPaddingOrTerminatorOpportunityStep.opportunitySlotPolynomial
            problem.verifier) +
        BuilderUnaryPolynomial.ruleCount
          (BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.widthPolynomial
            problem) +
        BuilderUnaryPolynomial.ruleCount
          (BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.opportunitySlotPolynomial
            problem.verifier) +
  ...
  have hPredecessor :=
    BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.rules_length problem
...
theorem rules_pairwise_query_distinct {language : Language}
  ...
  exact BuilderFirstClausePrefix.WorkChain.rules_pairwise_query_distinct
    (BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.machine problem)
    (suffixMachine problem)
    (BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.rules_pairwise_query_distinct
      problem)
...
def secondConstraintSeventhPaddingOrUnaryTokens {language : Language}
    (problem : VerifierTableauProblem language) : List CNFToken :=
  BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.secondConstraintSixthPaddingOrOpeningUnaryTokens
      problem ++
...
def widthOutside {language : Language}
  ...
  BuilderUnaryPolynomial.finalOutsideLeft
    ...
    (BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.finalOutside problem)
...
def controllerFinalOutside {language : Language}
  ...
  (widthWord problem).take (widthRootPrefixLength problem) ++
    ...
    [BuilderUnaryPolynomial.scratchEndSymbol,
     BuilderUnaryPolynomial.scratchEndSymbol] ++
    (BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.finalOutside problem).drop
...
def branchFinalTape {language : Language}
  ...
  BuilderTokenAppender.workspaceTape problem.input
    ...
    (secondConstraintSeventhPaddingOrUnaryTokens problem)
...
def workSteps {language : Language}
    (problem : VerifierTableauProblem language) : Nat :=
  BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.workSteps problem + 1 +
...
theorem widthEvaluator_workRunExact {language : Language}
    ...
    workRunExact? (widthEvaluator problem) (widthWorkSteps problem)
        (BuilderUnaryPolynomial.initialConfiguration
          (widthPolynomial problem) problem.input
          (BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.finalOutside
            problem)
          (BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.secondConstraintSixthPaddingOrOpeningUnaryTokens
            problem)) =
      some
  ...
  | succ remaining =>
      ...
      | zero =>
          ...
          simpa [hBranchWorkSteps, controllerWorkSteps,
            ...
            secondConstraintSeventhPaddingOrUnaryTokens, hOpportunityOutput,
    ...
    workRunExact? (targetEvaluator problem) (targetWorkSteps problem)
      ...
      some
        (BuilderUnaryPolynomial.finalConfiguration
          (opportunitySlotPolynomial problem.verifier) problem.input
          (controllerFinalOutside problem)
          (secondConstraintSeventhPaddingOrUnaryTokens problem)) := by
  exact BuilderUnaryPolynomial.workRunExact
    (opportunitySlotPolynomial problem.verifier) problem.input
    (controllerFinalOutside problem)
    (secondConstraintSeventhPaddingOrUnaryTokens problem)
...
private theorem widthBranch_workRunExact {language : Language}
    ...
    workRunExact? (widthBranchMachine problem)
        ...
        (workStartConfiguration (widthBranchMachine problem)
          (BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.finalTape
            problem)) =
      some
...
theorem suffix_workRunExact {language : Language}
  ...
  let widthBranchInitial := workStartConfiguration
    ...
    (BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.finalTape problem)
...
theorem prefix_workRunExact {language : Language}
    ...
    workRunExact? (machine problem)
        (BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.workSteps problem)
      ...
      some
        (renameConfiguration
          ...
          (BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.finalConfiguration
            problem)) := by
  ...
  have hRun := hTransport
    ...
    (BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.finalConfiguration
      problem)
    (BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.workRunExact problem)
  exact hRun
...
theorem workRunExact {language : Language}
  ...
  let prefixInitial := workStartConfiguration
    ...
    (rawInputWorkTape problem.input)
  let prefixFinal :=
    BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.finalConfiguration problem
...
theorem specification_opportunity_step {language : Language}
    ...
    VerifierTableauProblem.FormulaTokenCursor.step problem
        ⟨BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.finalTokenSlot
          problem⟩ =
      some ((if problem.dimensions.tapeWidth problem.tableauInputMode = 1
        ...
        ⟨BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.finalTokenSlot
          problem + 1⟩) := by
  exact
    BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.specification_following_step
      problem

/-- The finite output is exactly the canonical token prefix after consuming
the seventh width-selected padding-or-unary-token opportunity. -/
theorem secondConstraintSeventhPaddingOrUnaryTokens_eq_canonical_formula_prefix
    {language : Language} (problem : VerifierTableauProblem language) :
    ∃ rest, encodeCNFTokens problem.formula =
      secondConstraintSeventhPaddingOrUnaryTokens problem ++ rest := by
  rcases
      BuilderSecondConstraintFirstLiteralTerminatorStep.encodeCNFTokens_eq_terminator_then_successor_and_four_optional_unary_and_optional_terminator_and_optional_opening_unary_and_optional_first_unary
        problem with
    ⟨rest, hTokens⟩
  refine ⟨rest, ?_⟩
  unfold secondConstraintSeventhPaddingOrUnaryTokens
    BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.secondConstraintSixthPaddingOrOpeningUnaryTokens
    BuilderSecondConstraintFifthPaddingOrTerminatorOpportunityStep.secondConstraintFifthPaddingOrTerminatorTokens
  ...
  rw [
    ...
    BuilderSecondConstraintFifthPaddingOrTerminatorOpportunityStep.opportunityOutput_eq_nil_or_f,
    BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.opportunityOutput_eq_nil_or_t,
...
theorem finalTokenSlot_eq_predecessor_add_one {language : Language}
  (problem : VerifierTableauProblem language) :
    finalTokenSlot problem =
      BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.finalTokenSlot problem +
        1 := by
  rw [finalTokenSlot, opportunitySlot_eq_secondConstraintStart_add_fourteen,
    BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.finalTokenSlot_eq_secondConstraintStart_add_thirteen]

theorem finalTokenSlot_eq_secondConstraintStart_add_fourteen
    {language : Language} (problem : VerifierTableauProblem language) :
    finalTokenSlot problem =
      problem.formulaVariableSlotBound + 1 +
        problem.formulaClauseSlotsPerConstraint *
          problem.formulaTokensPerClause + 14 := by
  exact opportunitySlot_eq_secondConstraintStart_add_fourteen problem

/-- The retained coordinate identifies the opportunity after the processed
slot: another padding opportunity at width one, otherwise the second
unary-index `T` of the following literal. -/
theorem followingTokenSlot_direct_eq_padding_or_t {language : Language}
  ...
  have hFollowing :=
    BuilderSecondConstraintFirstLiteralTerminatorStep.eighthFollowingTokenSlot_direct_eq_padding_or_t
      problem
  rw [finalTokenSlot_eq_predecessor_add_one,
    BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.finalTokenSlot_eq_predecessor_add_one,
...
def rawTimeBound {language : Language}
  ...
  .add
    (BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.rawTimeBound verifier)
    (.add (.constant 684)
...
private theorem fourthTokens_length {language : Language}
    (problem : VerifierTableauProblem language) :
    (BuilderSecondConstraintFourthPaddingOrUnaryOpportunityStep.secondConstraintFourthPaddingOrUnaryTokens
      problem).length =
...
private theorem fifthTokens_length {language : Language}
    (problem : VerifierTableauProblem language) :
    (BuilderSecondConstraintFifthPaddingOrTerminatorOpportunityStep.secondConstraintFifthPaddingOrTerminatorTokens
      problem).length =
        problem.FormulaWidth + 43 +
  ...
  rw [
    ...
    List.length_append]
  have hOpportunity :
      (BuilderSecondConstraintFifthPaddingOrTerminatorOpportunityStep.opportunityOutput
        problem).length =
          if problem.dimensions.tapeWidth problem.tableauInputMode = 1
            then 0 else 1 := by
    rw [
    ...
    · simp [hWidth]
    · simp [hWidth]
  rw [fourthTokens_length, hOpportunity]
  by_cases hWidth :
      problem.dimensions.tapeWidth problem.tableauInputMode = 1
  · simp [hWidth]
  · simp [hWidth]
...
private theorem predecessorTokens_length {language : Language}
  ...
  rw [
    ...
    List.length_append]
  have hOpportunity :
      (BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.opportunityOutput
        problem).length =
          if problem.dimensions.tapeWidth problem.tableauInputMode = 1
            then 0 else 1 := by
    rw [
    ...
    · simp [hWidth]
    · simp [hWidth]
  rw [fifthTokens_length, hOpportunity]
  by_cases hWidth :
      problem.dimensions.tapeWidth problem.tableauInputMode = 1
  · simp [hWidth]
  · simp [hWidth]
...
after the seventh width-selected padding-or-unary-token opportunity. -/
theorem finalTokenBits_eq_encodedFormula_secondConstraintSeventhPaddingOrUnary
    {language : Language} (problem : VerifierTableauProblem language) :
    encodeTokenPairs (secondConstraintSeventhPaddingOrUnaryTokens problem) =
      problem.encodedFormula.take
        (2 * (problem.FormulaWidth + 43 +
          if problem.dimensions.tapeWidth problem.tableauInputMode = 1
            then 0 else 7)) := by
  rcases
      secondConstraintSeventhPaddingOrUnaryTokens_eq_canonical_formula_prefix
        problem with
    ⟨rest, hTokens⟩
  have hOutputLength :
  ...
  have hLength :
      (encodeTokenPairs
        (secondConstraintSeventhPaddingOrUnaryTokens problem)).length =
        2 * (problem.FormulaWidth + 43 +
          if problem.dimensions.tapeWidth problem.tableauInputMode = 1
            then 0 else 7) := by
    rw [encodeTokenPairs_length,
      secondConstraintSeventhPaddingOrUnaryTokens, List.length_append,
...
private theorem appenderWorkSteps_le {language : Language}
    ...
    appenderWorkSteps problem ≤
      4 * problem.input.length + 2 * problem.FormulaWidth + 106 := by
...
theorem rawTimeBound_eval {language : Language}
    ...
    (rawTimeBound problem.verifier).eval problem.input.length =
      ...
      684 + 24 * problem.input.length + 12 * problem.FormulaWidth +
  ...
  unfold width widthPolynomial widthRootPrefixLength widthWorkSteps
    targetWorkSteps
  simp only
    [BuilderSecondConstraintSeventhPaddingOrUnaryOpportunityStep.widthPolynomial]
  omega
...
theorem rawTimeBound_le {language : Language}
  ...
  have hPrefix :=
    BuilderSecondConstraintSixthPaddingOrOpeningUnaryOpportunityStep.rawTimeBound_le problem
...
end BuilderSecondConstraintSeventhPaddingOrUnaryOpportunityStep
