...
The third width-dependent padding-or-unary opportunity after the first
...
third unary unit.  Both branches then materialize the following formula
...
process the following padding or fourth unary token, complete the second
...
namespace BuilderSecondConstraintThirdPaddingOrUnaryOpportunityStep
...
theorem opportunitySlot_eq_secondConstraintStart_add_ten
  ...
  change
    BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.opportunitySlot
        problem +
      1 = _
  rw [
    BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.opportunitySlot_eq_secondConstraintStart_add_nine]
...
def machine {language : Language}
    (problem : VerifierTableauProblem language) : WorkMachine :=
  BuilderFirstClausePrefix.WorkChain.machine
    (BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.machine problem)
...
private theorem predecessor_noRuleAtAccept {language : Language}
    ...
    BuilderFirstClausePrefix.WorkChain.NoRuleAtAccept
      (BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.machine problem) := by
  exact
    BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.rule_source_ne_acceptState
      problem
...
theorem rules_length {language : Language}
  ...
  have hPredecessor :=
    BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.rules_length problem
...
theorem rules_pairwise_query_distinct {language : Language}
  ...
  exact BuilderFirstClausePrefix.WorkChain.rules_pairwise_query_distinct
    (BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.machine problem)
    (suffixMachine problem)
    (BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.rules_pairwise_query_distinct
      problem)
...
def secondConstraintThirdPaddingOrUnaryTokens {language : Language}
    (problem : VerifierTableauProblem language) : List CNFToken :=
...
def widthOutside {language : Language}
  ...
  BuilderUnaryPolynomial.finalOutsideLeft
    ...
    (BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.finalOutside problem)
...
def controllerFinalOutside {language : Language}
  ...
  (widthWord problem).take (widthRootPrefixLength problem) ++
    ...
    [BuilderUnaryPolynomial.scratchEndSymbol,
     BuilderUnaryPolynomial.scratchEndSymbol] ++
    (BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.finalOutside problem).drop
...
def branchFinalTape {language : Language}
  ...
  BuilderTokenAppender.workspaceTape problem.input
    ...
    (secondConstraintThirdPaddingOrUnaryTokens problem)
...
def workSteps {language : Language}
    (problem : VerifierTableauProblem language) : Nat :=
  BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.workSteps problem + 1 +
...
theorem widthEvaluator_workRunExact {language : Language}
    ...
    workRunExact? (widthEvaluator problem) (widthWorkSteps problem)
        (BuilderUnaryPolynomial.initialConfiguration
          (widthPolynomial problem) problem.input
          (BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.finalOutside
            problem)
          (BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.secondConstraintSecondPaddingOrUnaryTokens
            problem)) =
      some
  ...
  | succ remaining =>
      ...
      | zero =>
          ...
          simpa [hBranchWorkSteps, controllerWorkSteps,
            ...
            secondConstraintThirdPaddingOrUnaryTokens, hOpportunityOutput,
    ...
    workRunExact? (targetEvaluator problem) (targetWorkSteps problem)
      ...
      some
        (BuilderUnaryPolynomial.finalConfiguration
          (opportunitySlotPolynomial problem.verifier) problem.input
          (controllerFinalOutside problem)
          (secondConstraintThirdPaddingOrUnaryTokens problem)) := by
  exact BuilderUnaryPolynomial.workRunExact
    (opportunitySlotPolynomial problem.verifier) problem.input
    (controllerFinalOutside problem)
    (secondConstraintThirdPaddingOrUnaryTokens problem)
...
private theorem widthBranch_workRunExact {language : Language}
    ...
    workRunExact? (widthBranchMachine problem)
        ...
        (workStartConfiguration (widthBranchMachine problem)
          (BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.finalTape
            problem)) =
      some
...
theorem suffix_workRunExact {language : Language}
  ...
  let widthBranchInitial := workStartConfiguration
    ...
    (BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.finalTape problem)
...
theorem prefix_workRunExact {language : Language}
    ...
    workRunExact? (machine problem)
        (BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.workSteps problem)
      ...
      some
        (renameConfiguration
          ...
          (BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.finalConfiguration
            problem)) := by
  ...
  have hRun := hTransport
    ...
    (BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.finalConfiguration
      problem)
    (BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.workRunExact problem)
  exact hRun
...
theorem workRunExact {language : Language}
  ...
  let prefixInitial := workStartConfiguration
    ...
    (rawInputWorkTape problem.input)
  let prefixFinal :=
    BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.finalConfiguration problem
...
theorem specification_opportunity_step {language : Language}
    ...
    VerifierTableauProblem.FormulaTokenCursor.step problem
        ⟨BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.finalTokenSlot
          problem⟩ =
      some ((if problem.dimensions.tapeWidth problem.tableauInputMode = 1
        ...
        ⟨BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.finalTokenSlot
          problem + 1⟩) := by
  exact
    BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.specification_following_step
      problem

/-- The finite output is exactly the canonical token prefix after consuming
the third width-selected padding-or-unary opportunity. -/
theorem secondConstraintThirdPaddingOrUnaryTokens_eq_canonical_formula_prefix
    {language : Language} (problem : VerifierTableauProblem language) :
    ∃ rest, encodeCNFTokens problem.formula =
      secondConstraintThirdPaddingOrUnaryTokens problem ++ rest := by
  rcases
      BuilderSecondConstraintFirstLiteralTerminatorStep.encodeCNFTokens_eq_terminator_then_successor_and_three_optional_unary
        problem with
    ⟨rest, hTokens⟩
  refine ⟨rest, ?_⟩
  unfold secondConstraintThirdPaddingOrUnaryTokens
    BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.secondConstraintSecondPaddingOrUnaryTokens
...
theorem finalTokenSlot_eq_predecessor_add_one {language : Language}
  (problem : VerifierTableauProblem language) :
    finalTokenSlot problem =
      BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.finalTokenSlot problem +
        1 := by
  rw [finalTokenSlot, opportunitySlot_eq_secondConstraintStart_add_ten,
    BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.finalTokenSlot_eq_secondConstraintStart_add_nine]

theorem finalTokenSlot_eq_secondConstraintStart_add_ten
    {language : Language} (problem : VerifierTableauProblem language) :
    finalTokenSlot problem =
      problem.formulaVariableSlotBound + 1 +
        problem.formulaClauseSlotsPerConstraint *
          problem.formulaTokensPerClause + 10 := by
  exact opportunitySlot_eq_secondConstraintStart_add_ten problem

/-- The retained coordinate identifies the opportunity after the processed
slot: another padding opportunity at width one, otherwise the fourth unary
...
theorem followingTokenSlot_direct_eq_padding_or_t {language : Language}
  ...
  have hFollowing :=
    BuilderSecondConstraintFirstLiteralTerminatorStep.fourthFollowingTokenSlot_direct_eq_padding_or_t
      problem
...
def rawTimeBound {language : Language}
  ...
  .add
    (BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.rawTimeBound verifier)
    (.add (.constant 636)
...
private theorem predecessorTokens_length {language : Language}
    ...
    (BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.secondConstraintSecondPaddingOrUnaryTokens
      problem).length =
        problem.FormulaWidth + 43 +
          (if problem.dimensions.tapeWidth problem.tableauInputMode = 1
            then 0 else 2) := by
  rw [BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.secondConstraintSecondPaddingOrUnaryTokens,
    List.length_append]
  ...
  have hSecondOpportunity :
    ...
    · simp [hWidth]
    · simp [hWidth]
  rw [hFirstOpportunity, hSecondOpportunity]
  by_cases hWidth :
      problem.dimensions.tapeWidth problem.tableauInputMode = 1
  · simp [hWidth]
  · simp [hWidth]
...
after the third width-selected padding-or-unary opportunity. -/
theorem finalTokenBits_eq_encodedFormula_secondConstraintThirdPaddingOrUnary
    {language : Language} (problem : VerifierTableauProblem language) :
    encodeTokenPairs (secondConstraintThirdPaddingOrUnaryTokens problem) =
      problem.encodedFormula.take
        (2 * (problem.FormulaWidth + 43 +
          if problem.dimensions.tapeWidth problem.tableauInputMode = 1
            then 0 else 3)) := by
  rcases
      secondConstraintThirdPaddingOrUnaryTokens_eq_canonical_formula_prefix
        problem with
    ⟨rest, hTokens⟩
  have hOutputLength :
  ...
  have hLength :
      (encodeTokenPairs
        (secondConstraintThirdPaddingOrUnaryTokens problem)).length =
        2 * (problem.FormulaWidth + 43 +
          if problem.dimensions.tapeWidth problem.tableauInputMode = 1
            then 0 else 3) := by
    rw [encodeTokenPairs_length,
      secondConstraintThirdPaddingOrUnaryTokens, List.length_append,
...
private theorem appenderWorkSteps_le {language : Language}
    ...
    appenderWorkSteps problem ≤
      4 * problem.input.length + 2 * problem.FormulaWidth + 98 := by
...
theorem rawTimeBound_eval {language : Language}
    ...
    (rawTimeBound problem.verifier).eval problem.input.length =
      ...
      636 + 24 * problem.input.length + 12 * problem.FormulaWidth +
...
theorem rawTimeBound_le {language : Language}
  ...
  have hPrefix :=
    BuilderSecondConstraintSecondPaddingOrUnaryOpportunityStep.rawTimeBound_le problem
...
end BuilderSecondConstraintThirdPaddingOrUnaryOpportunityStep
