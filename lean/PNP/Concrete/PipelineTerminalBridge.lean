...
This module does not yet transport the earlier framer/simulator/handoff trace
from ordinary paired input into the extended machine.  It therefore does not
construct a complete pipeline RawRefinement, prove target termination, give a
polynomial in external encoded input length, prove CNFSAT in P or
