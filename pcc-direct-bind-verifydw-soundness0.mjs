...
const EXPECTED_COMPONENT_IDS = ['E.VerifyDWSoundnessSurface', 'E.ObligationLifecycleSurface', 'E.NoHiddenMinimizationSurface', 'E.SoundnessActivationBoundary'];
...
export async function CheckEDirectBindingSeed0(options = {}) {
  ...
  try {
    ...
    return writeAndReturn0(root, outputPath, writeOutput, {
      ...
      manifestSha256: sha256Hex0(manifestRead.bytes), inventorySha256: sha256Hex0(inventoryRead.bytes), matrixSha256: sha256Hex0(matrixRead.bytes), closurePlanSha256: sha256Hex0(closureRead.bytes), proofObligationLedgerSha256: sha256Hex0(obligationsRead.bytes), gapLedgerSha256: sha256Hex0(gapsRead.bytes), noHiddenOracleAuditSha256: sha256Hex0(oracleRead.bytes), checkerTotalityAuditSha256: sha256Hex0(totalityRead.bytes), negativeCheckerMutationSha256: sha256Hex0(mutationsRead.bytes), ruleFamilyCoverageSha256: sha256Hex0(ruleCoverageRead.bytes), statusSha256: sha256Hex0(statusRead.bytes),
