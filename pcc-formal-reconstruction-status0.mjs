...
const VERSION = 0;
const COORDINATE = 'PNP-FORMAL-RECONSTRUCTION-STATUS-2026-09-20-280';
...
const VERIFICATION_COMMANDS = Object.freeze([
  ...
  "lake env lean -DwarningAsError=true lean-regression/PNPGateRenamingEncoding.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPWireCarrierRecoding.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPWireRecodingState.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPWireRecodingOwnership.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPWireRecodingInput.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPWireRecodingProgram.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPWireRecodingCertificate.lean",
  "npm run audit:m271",
  "node scripts/check-lean-axioms.mjs lean-audit/PNPStructuralProgramsAxiomAudit.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPReindexingCausalBounds.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPWireStructuralState.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPWireStructuralOwnership.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPWireStructuralProgram.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPWireStructuralCertificate.lean",
  "npm run audit:m267",
  "node scripts/check-lean-axioms.mjs lean-audit/PNPDescendantHistoryOwnershipAxiomAudit.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPWireDescendantInput.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPWireDescendantStage.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPWireDescendantRun.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPWireDescendantLedger.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPWireDescendantOwnership.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPWireDescendantEvents.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPWireDescendantCharges.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPWireDescendantGain.lean",
  "npm run audit:m266",
  "node scripts/check-lean-axioms.mjs lean-audit/PNPSourceDerivedHistoryOwnershipAxiomAudit.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPPhysicalGateProvenance.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPWireHistoryPhysicalOwnership.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPCompiledGateProvenance.lean",
  "lake env lean -DwarningAsError=true lean-regression/PNPWireHistoryAmbientOwnership.lean",
  'node --test audits/lean-finite-dependency-scheduler0.test.mjs audits/lean-wire-obligation-history-state0.test.mjs audits/lean-wire-obligation-history0.test.mjs audits/lean-wire-obligation-history-execution0.test.mjs audits/lean-wire-obligation-history-publication0.test.mjs',
  'lake env lean -DwarningAsError=true lean-audit/PNPWireObligationHistoryAxiomAudit.lean',
  'lake env lean -DwarningAsError=true lean-regression/PNPWireObligationHistory.lean',
  ...
  'node --test audits/lean-wire-causal-expansion0.test.mjs',
  'lake env lean -DwarningAsError=true lean-audit/PNPWireCausalExpansionAxiomAudit.lean',
  'lake env lean -DwarningAsError=true lean-regression/PNPWireCausalExpansion.lean',
  ...
  'node --test audits/lean-concrete-cook-levin-builder-post-divider-raw-route-classifier0.test.mjs',
  ...
  'node --test audits/lean-concrete-cook-levin-builder-physical-finish-request0.test.mjs',
  'node --test audits/lean-concrete-cook-levin-builder-physical-classifier-pipeline0.test.mjs',
  'node --test audits/lean-concrete-cook-levin-builder-physical-classifier-finish-request0.test.mjs',
  'node --test audits/lean-concrete-cook-levin-builder-physical-classifier-finish-workspace-orientation0.test.mjs',
  'node --test audits/lean-concrete-cook-levin-builder-physical-classifier-finish-mirrored-dispatch0.test.mjs',
  'node --test audits/lean-concrete-cook-levin-builder-physical-classifier-first-body-separator-mirrored-dispatch0.test.mjs',
  'node --test audits/lean-concrete-cook-levin-builder-physical-classifier-all-body-staged-request-mirrored-dispatch0.test.mjs',
  'node --test audits/lean-concrete-cook-levin-builder-physical-classifier-terminal-join0.test.mjs',
  ...
  'lake env lean -DwarningAsError=true lean-audit/PNPConcreteCookLevinNPCompletenessAxiomAudit.lean',
  'lake env lean -DwarningAsError=true lean-regression/PNPConcreteCookLevinNPCompleteness.lean',
  ...
  'lake env lean -DwarningAsError=true lean-audit/PNPConcreteCookLevinBuilderPostDividerRawRouteClassifierAxiomAudit.lean',
  'lake env lean -DwarningAsError=true lean-regression/PNPConcreteCookLevinBuilderPostDividerRawRouteClassifier.lean',
  'lake env lean -DwarningAsError=true lean-audit/PNPConcreteCookLevinBuilderPostDividerSelectedTokenLaunchAxiomAudit.lean',
  'lake env lean -DwarningAsError=true lean-regression/PNPConcreteCookLevinBuilderPostDividerSelectedTokenLaunch.lean',
  'lake env lean -DwarningAsError=true lean-audit/PNPConcreteCookLevinBuilderCompleteScheduleIterationAxiomAudit.lean',
  ...
  'lake env lean -DwarningAsError=true lean-audit/PNPConcreteCookLevinBuilderPhysicalFinishRequestAxiomAudit.lean',
  'lake env lean -DwarningAsError=true lean-regression/PNPConcreteCookLevinBuilderPhysicalFinishRequest.lean',
  'lake env lean -DwarningAsError=true lean-audit/PNPConcreteCookLevinBuilderPhysicalClassifierPipelineAxiomAudit.lean',
  'lake env lean -DwarningAsError=true lean-regression/PNPConcreteCookLevinBuilderPhysicalClassifierPipeline.lean',
  'lake env lean -DwarningAsError=true lean-audit/PNPConcreteCookLevinBuilderPhysicalClassifierFinishRequestAxiomAudit.lean',
  'lake env lean -DwarningAsError=true lean-regression/PNPConcreteCookLevinBuilderPhysicalClassifierFinishRequest.lean',
  'lake env lean -DwarningAsError=true lean-audit/PNPConcreteCookLevinBuilderPhysicalClassifierFinishWorkspaceOrientationAxiomAudit.lean',
  'lake env lean -DwarningAsError=true lean-regression/PNPConcreteCookLevinBuilderPhysicalClassifierFinishWorkspaceOrientation.lean',
  'lake env lean -DwarningAsError=true lean-audit/PNPConcreteCookLevinBuilderPhysicalClassifierFinishMirroredDispatchAxiomAudit.lean',
  'lake env lean -DwarningAsError=true lean-regression/PNPConcreteCookLevinBuilderPhysicalClassifierFinishMirroredDispatch.lean',
  'lake env lean -DwarningAsError=true lean-audit/PNPConcreteCookLevinBuilderPhysicalClassifierFirstBodySeparatorMirroredDispatchAxiomAudit.lean',
  'lake env lean -DwarningAsError=true lean-regression/PNPConcreteCookLevinBuilderPhysicalClassifierFirstBodySeparatorMirroredDispatch.lean',
  'lake env lean -DwarningAsError=true lean-audit/PNPConcreteCookLevinBuilderPhysicalClassifierAllBodyStagedRequestMirroredDispatchAxiomAudit.lean',
  'lake env lean -DwarningAsError=true lean-regression/PNPConcreteCookLevinBuilderPhysicalClassifierAllBodyStagedRequestMirroredDispatch.lean',
  'lake env lean -DwarningAsError=true lean-audit/PNPConcreteCookLevinBuilderPhysicalClassifierTerminalJoinAxiomAudit.lean',
  'lake env lean -DwarningAsError=true lean-regression/PNPConcreteCookLevinBuilderPhysicalClassifierTerminalJoin.lean',
  'lake env lean -DwarningAsError=true lean-audit/PNPConcreteCookLevinBuilderPhysicalClassifierAllRouteStagedRequestMirroredDispatchAxiomAudit.lean',
  'lake env lean -DwarningAsError=true lean-regression/PNPConcreteCookLevinBuilderPhysicalClassifierAllRouteStagedRequestMirroredDispatch.lean',
  ...
  'lake env lean -DwarningAsError=true lean-audit/PNPPCCMinCheckedPacketBN6HBZeroSlackBridgeAxiomAudit.lean',
  'lake env lean -DwarningAsError=true lean-regression/PNPPCCMinCheckedPacketBN6HBZeroSlackBridge.lean',
  'node --test audits/lean-pccmin-checked-packet-bn6-hb-zeroslack-bridge0.test.mjs',
  ...
  'lake env lean -DwarningAsError=true lean-audit/PNPResidualTerminalPkgCRestorationCoverageAmbientRouteAxiomAudit.lean',
  'lake env lean -DwarningAsError=true lean-regression/PNPResidualTerminalPkgCRestorationCoverageAmbientRoute.lean',
  'node --test audits/lean-residual-terminal-pkgc-restoration-coverage-ambient-route0.test.mjs',
  ...
  'lake env lean -DwarningAsError=true lean-audit/PNPPCCMinCheckedPacketPkgCRestorationCoverageChargeDescentAxiomAudit.lean',
  'lake env lean -DwarningAsError=true lean-regression/PNPPCCMinCheckedPacketPkgCRestorationCoverageChargeDescent.lean',
  'node --test audits/lean-pccmin-checked-packet-pkgc-restoration-coverage-charge-descent0.test.mjs',
...
const NON_CLAIMS = Object.freeze([
  ...
  'CookLevin.BuilderPostHeaderRawDivider adds one fixed 99-rule unary quotient/remainder machine. For every natural dividend and positive unary width it proves an exact accepting trace, exact six-transition raw compilation, decoded natural quotient and strict remainder, a one-step-short timeout boundary, and an explicit quadratic bound in the complete unary input length. The divider is standalone: it is not spliced onto M209 raw output, does not emit or append a Cook-Levin body token, and does not complete the raw formula builder, RawRefinement, PolynomialReduction, CNFSAT NP-hardness or in-P result, or P = NP.',
  'CookLevin.BuilderPostHeaderRawLaunch composes M209 remainder extraction, M210 route classification and M211 division through executable Lean orchestration for every natural coordinate. It preserves both exact machine traces, recovers body, Finish and out-of-range results, excludes out-of-range post-header routing inside the complete schedule, and bounds the summed compiled steps by one verifier-derived source-size polynomial. It is not a literal raw tape bridge, does not preserve the complete builder workspace through such a rewrite, emits no body or Finish token, and does not complete the raw formula builder, RawRefinement, PolynomialReduction, CNFSAT NP-hardness or in-P result, or P = NP.',
  'CookLevin.BuilderPostHeaderRawTapeBridge replaces M212\'s value-level handoff with one fixed 351-rule literal bridge from both exact M209 post-header terminal tapes into M211\'s shielded unary divider input. It preserves arbitrary exterior builder workspace, retains the exact bridge and divider traces, recovers the exact quotient and remainder after removing the exterior, compiles every checked work step to six raw steps, fails closed at zero width, times out one step short, covers every in-range coordinate without supplied route data, and has one verifier-derived source-size polynomial bound. It does not emit a body or Finish token, iterate the complete builder, provide RawRefinement, package the PolynomialReduction, prove CNFSAT NP-hard or in P, close a global gate, or prove P = NP.',
  'CookLevin.BuilderPostDividerRawRouteClassifier closes the next literal post-divider routing boundary with one fixed 180-rule bridge. It consumes both exact M213 divider-terminal tapes, copies the exact problem-derived clause count from a restored workspace sidecar, preserves the complete exterior and remainder ledger, exposes the quotient to a shielded M209 comparator, and agrees for every in-range coordinate with M210 body or Finish routing. Both machines retain exact compiled traces, one-step-short nonhalting evidence, and one verifier-derived source-size polynomial bound. It does not inspect or emit a selected token, iterate the complete builder, provide RawRefinement, package the PolynomialReduction, prove CNFSAT NP-hard or in P, close a global gate, or prove P = NP.',
  ...
  "CookLevin.BuilderPhysicalClassifierPipeline composes M213's post-header bridge, M211's raw divider, M214's post-divider bridge and M209's raw comparator as one fixed collision-free 711-rule machine for every canonical post-header coordinate and arbitrary protected workspace. Three exact tape handoffs, exact work and six-for-one compiled traces, one-step-short nonhalting, body-versus-Finish route agreement and one verifier-derived polynomial bound are formalized without supplied route, quotient, remainder or trace data. This closes the suffix-preserving physical classifier pipeline, but does not derive body-token or padding request symbols, connect those requests to M217, iterate one literal raw loop, complete builder RawRefinement, package the reduction, close a checkpoint or global gate, or prove P = NP.",
  "CookLevin.BuilderPhysicalClassifierFinishRequest derives the unique canonical Finish coordinate, reinterprets M220's Finish terminal without changing classifier transition semantics, and chains the full 711-rule classifier pipeline to M219's one-cell writer as one collision-free 721-rule machine. Exact work and six-for-one compiled traces, one-step-short nonhalting, the exact final tape write over arbitrary protected workspace, and one verifier-derived polynomial bound are formalized without supplied coordinate, request, route or trace data. This closes only the full-classifier-to-Finish-request-cell edge; body-token and padding request generation, dispatcher-ready workspace orientation, connection to M217, one literal raw loop, builder RawRefinement, the packaged reduction, every fixed checkpoint and every global gate remain open.",
  "CookLevin.BuilderPhysicalClassifierFinishWorkspaceOrientation adds one blank sentinel before the canonical builder workspace and chains M221's complete-classifier Finish writer to a fixed ten-rule left scanner. The collision-free 740-rule composition proves the classifier prefix contains no blank, crosses exactly that derived prefix, and halts with a tape equal to the spatial mirror of M217's canonical Finish request entry. Exact work and six-for-one compiled traces, one-step-short nonhalting, a prefix-size bound and one verifier-derived polynomial bound are formalized without supplied prefix, trace or geometry data. Mirrored dispatcher execution, body-token and padding request generation, one literal raw loop, builder RawRefinement, the packaged reduction, every fixed checkpoint and every global gate remain open.",
  "CookLevin.BuilderPhysicalClassifierFinishMirroredDispatch mechanically reflects M217's fixed dispatcher by exchanging left and right moves while preserving its finite rule table and states, and proves exact execution transport under tape reflection. Chained after M222, one collision-free 813-rule machine executes the complete classifier's unique Finish path through that reflected dispatcher and reaches a reflected appender endpoint containing the complete canonical CNF token stream. Exact work and six-for-one compiled traces, one-step-short nonhalting and one verifier-derived polynomial bound are formalized without supplied prefix, trace, request or geometry data. Body-token and padding request generation, all-route dispatcher connection, one literal repeated loop, builder RawRefinement, the packaged reduction, every fixed checkpoint and every global gate remain open.",
  "CookLevin.BuilderPhysicalClassifierFirstBodySeparatorMirroredDispatch derives the first post-header coordinate and its separator entry from every verifier problem, runs the complete 711-rule classifier through its populated-body terminal, crosses the positive clause-count suffix with a fixed two-rule writer, reorients the protected builder workspace with a fixed ten-rule scanner, and executes M223's reflected M217 dispatcher. One collision-free 814-rule machine reaches the exact canonical prefix ending at the first clause separator, with exact work, compiled, one-step-short and source-size polynomial evidence and no supplied coordinate, request, trace or geometry. Arbitrary body-token and padding request generation, all-route dispatcher connection, one literal repeated loop, builder RawRefinement, the packaged reduction, every fixed checkpoint and every global gate remain open.",
  "CookLevin.BuilderPhysicalClassifierAllBodyStagedRequestMirroredDispatch quantifies over every coordinate in each verifier problem's complete clause-token body rectangle, runs the complete 711-rule classifier while preserving an explicit canonical optional-token request, relays that protected request through one fixed 14-rule scanner, and executes M223's reflected 64-rule dispatcher. One collision-free 807-rule composition reaches each exact next canonical emitted prefix for populated and padding coordinates, with exact work, compiled, one-step-short and source-size polynomial evidence and no caller-supplied coordinate, request, trace or machine. The request remains staged rather than synthesized from raw classifier state; the unique Finish route is not joined into the same repeated loop, and builder RawRefinement, the packaged reduction, every fixed checkpoint and every global gate remain open.",
  "CookLevin.BuilderPhysicalClassifierTerminalJoin wraps the complete 711-rule all-coordinate physical classifier in one injective namespace and adds a total nine-rule, tape-preserving redirect from its unique Finish/reject terminal to the same continuation-ready accepting state used by every body coordinate. The resulting collision-free 720-rule table works for every verifier-derived post-header coordinate and arbitrary protected workspace, proves zero extra body steps, exactly one Finish redirect, exact work and compiled traces, one-step-short nonhalting and one source-size polynomial bound without a caller-supplied coordinate, route, verdict, trace or machine. It does not synthesize or dispatch a body request, connect successive coordinates, implement a repeated physical builder loop, prove builder RawRefinement, package the Cook-Levin reduction, close a fixed checkpoint or close a global gate.",
  "CookLevin.BuilderPhysicalClassifierAllRouteStagedRequestMirroredDispatch runs M226's fixed terminal-joined classifier over every verifier-derived post-header coordinate with one canonical optional-token request explicitly staged behind a protected blank sentinel. One fixed 14-rule relay crosses the exact blank-free body-or-Finish classifier prefix, validates all five request values, and feeds M217's reflected fixed 64-rule dispatcher. The collision-free 816-rule composition reaches every exact next canonical emitted prefix with exact work and compiled traces, one-step-short nonhalting and one source-size polynomial bound. Its 65 public declarations have 23 empty, four propext-only and 38 propext/Quot.sound closures, with no project axiom or Classical.choice. It does not synthesize the request from raw classifier state, connect successive configurations, implement the repeated physical loop, prove builder RawRefinement, package the Cook-Levin reduction, close a fixed checkpoint or close a global gate.",
  "CookLevin.BuilderPhysicalClassifierAllRouteDerivedFinishSplit runs M226's fixed terminal-joined classifier over every verifier-derived post-header coordinate without a staged request cell. One fixed 20-rule relay reads the physical body-or-Finish terminal, crosses the exact blank-free classifier prefix, writes a collision-free non-request pending marker for every body route, and writes the canonical Finish request only for the unique Finish route. A fixed 65-rule conditional reflected dispatcher rejects the body-pending marker and sends Finish to the exact next canonical emitted prefix. The collision-free 823-rule composition has exact work and compiled traces, one-step-short nonhalting and one source-size polynomial bound. Its 91 public declarations have 50 empty, 18 propext-only and 23 propext/Quot.sound closures, with no project axiom or Classical.choice. It does not synthesize body-token or padding requests, connect successive configurations, implement the repeated physical loop, prove builder RawRefinement, package the Cook-Levin reduction, close a fixed checkpoint or close a global gate.",
  "CookLevin.BuilderPhysicalClassifierAllRouteBodyRemainderSplit: For every concrete verifier problem and every coordinate in its complete post-header schedule, M229 runs M228 without a staged request, route, remainder or success certificate. It preserves the completed Finish endpoint and sends every body route through one fixed 36-rule physical scanner. The scanner crosses the retained clause-count and exterior boundaries, skips consumed-dividend marks, and distinguishes zero from positive remainder by the actual separator or unit symbol. The physical remainder equals the canonical body token coordinate. The collision-free 895-rule graph has exact work, six-for-one compiled execution, one-step-short nonhalting, and a verifier-input-size polynomial bound. All 71 public declarations are axiom-audited: 39 have empty closure, nine use only propext, and 23 use only propext and Quot.sound, with no project axiom or Classical.choice. This milestone reads the physical body remainder but leaves clause occupancy and body-token and padding request synthesis open. Both body outcomes remain incomplete terminal configurations, distinguished by tape content. It does not connect successive schedule configurations, implement the repeated builder loop, prove builder FunctionProgram.RawRefinement, or package the Cook-Levin PolynomialReduction. It does not establish CNFSAT NP-hardness or NP-completeness transport or CNFSAT in P, close a fixed checkpoint or global gate, create the eligible root theorem, or prove P = NP.",
  "CookLevin.BuilderPhysicalFinishRequest derives the unique canonical Finish coordinate from every verifier problem, preserves the builder suffix past M214's comparator boundary, swaps the equal terminal into an accepting classifier, writes M217's physical Finish request with one fixed rule, and composes the classifier, writer and dispatcher as one collision-free 137-rule machine. Exact work, six-for-one compiled and one-step-short traces hold for arbitrary classifier exterior, and one verifier-derived polynomial bounds compiled work. It covers only Finish: body and padding request derivation, the preceding suffix-preserving classifier handoff, one literal repeated loop, complete builder RawRefinement, the packaged reduction, fixed checkpoints and global gates remain open.",
  ...
  'The M207 PkgC restoration-coverage charge route computes unsigned BN4 charge as the sum of cell masses, proves exact permutation-invariant decomposition across M206\'s coverage-derived cancellation subledger and remainder, and derives strict chargeSize-coordinate descent in the ten-coordinate residual rank for every fixed surrounding context. The exact canonical residual ledger is preserved and no rank, inequality, descent proof or success flag is supplied by the caller. The terminal problem, source cells, restoration universes and maps, ambient ledgers, semantic full candidates, Packet ranks and claims, dependency table, checked HB closure, route-clear result and selector silence remain supplied; Hall, ambient-incompatibility and activation-mismatch outcomes are not complete global descents, the remainder is not proved empty, and no complete encoded-input polynomial construction or runtime theorem is proved. This does not close complete global route coverage, PkgC/BN3--BN6 integration, manuscript-wide SaturatePositive or BCELReady, unconditional ZeroSlack, executable polynomial PCCMin, any global gate, SAT in P, the eligible root theorem, or P = NP.',
  ...
  "M262 constructs a total source-ordered physical expansion under no supplied order or compiler-success witness. Complete local open-function agreement is required for semantic preservation. Exact cost E + K * R permits strict original-size saving only when K * R < S; arbitrary local saving does not imply global saving. Matched-kappa Pull/Expand, the full R5-R8 obligation calculus, complete Package E, global routes, unconditional ZeroSlack and complete polynomial PCCMin remain open.",
]);
...
const EXACT_FIELDS = Object.freeze({
  ...
  leanPCCMinCheckedPacketBN6BCELCanonicalGroupingScope:
    'arbitrary-finite-same-candidate-checked-bcel-nucleus-and-supplied-raw-positive-support-payload-ledger-with-carrier-normalized-supports-canonical-singleton-consumer-systems-duplicate-footprint-coalescing-payload-preservation-and-exact-activation-mismatch-or-conditional-zeroslack',
  ...
  leanPCCMinCheckedPacketBN6BCELSparseActivationRouteScope:
    'arbitrary-finite-sparse-positive-v53-singleton-pair-proper-cut-equation-equivalent-to-all-proper-cuts-with-quadratic-list-bound-total-first-mismatch-classifier-and-direct-checked-raw-activation-mismatch-or-conditional-zeroslack-over-supplied-terminal-data',
  ...
  leanResidualTerminalPkgCRestorationCoverageAmbientRouteScope:
    'arbitrary-finite-restoration-coordinate-coverage-classified-as-an-exact-q-restoration-hall-deficit-or-a-constructed-balanced-bn4-unit-cancellation-subledger-with-computed-arbitrary-order-ambient-remainder-exact-residual-reduction-or-proof-of-no-exact-embedding',
  ...
  leanPCCMinCheckedPacketPkgCRestorationCoverageChargeDescentScope:
    'arbitrary-finite-m206-restoration-coverage-ambient-embedding-with-mass-sensitive-unsigned-charge-decomposition-strict-remainder-charge-decrease-and-context-parametric-exact-terminal-residual-rank-charge-coordinate-descent-while-all-other-m206-outcomes-remain-explicit',
...
function publicationExpected0(publication, inventory, publicationMap, publicationMapSha256, sourceClosureSha256) {
  ...
  return {
    ...
    canonicalReportCoordinate: COORDINATE.replace(
