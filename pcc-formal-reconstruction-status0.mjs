...
const VERSION = 0;
const COORDINATE = 'PNP-FORMAL-RECONSTRUCTION-STATUS-2026-07-10-05';
...
const NON_CLAIMS = Object.freeze([
  ...
  'The exact-width syntactic NAND enumeration does not prove canonical/deduplicated enumeration, semantic equivalence decision, minimum size, replacement/slack, the locked builder/threshold, SAT, or P = NP.',
...
const EXACT_FIELDS = Object.freeze({
  ...
  publicSurfaceBaselineCoordinate: 'PUBLIC-SURFACE-BASELINE-2026-07-10-NAND-ENUMERATOR-05',
