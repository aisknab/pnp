...
const VERSION = 0;
const COORDINATE = 'PNP-FORMAL-RECONSTRUCTION-STATUS-2026-07-11-16';
...
const NON_CLAIMS = Object.freeze([
  ...
  'PipelineMachineSimulation executes one successful raw transition from an already encoded boundary frame in exactly three work transitions and eighteen transitions of the compiled raw machine; it does not create an initial frame, decode or normalize output, execute a terminal handoff, simulate a bounded run, compile composition or precomposition, provide a RawRefinement, or prove an end-to-end polynomial bound.',
...
const EXACT_FIELDS = Object.freeze({
  ...
  publicSurfaceBaselineCoordinate: 'PUBLIC-SURFACE-BASELINE-2026-07-11-PIPELINE-MACHINE-SIMULATION-16',
...
function publicationExpected0(publication, inventory, publicationMap, publicationMapSha256, sourceClosureSha256) {
  ...
  return {
    ...
    canonicalReportCoordinate: 'PNP-CANONICAL-FORMAL-RECONSTRUCTION-REPORT-2026-07-11-16',
