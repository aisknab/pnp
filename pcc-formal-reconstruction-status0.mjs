...
const VERSION = 0;
const COORDINATE = 'PNP-FORMAL-RECONSTRUCTION-STATUS-2026-07-17-50';
...
const NON_CLAIMS = Object.freeze([
  ...
  'CookLevin.BuilderFirstClausePrefix composes the complete first-literal machine, a structurally generated unary evaluator for the retained next-token coordinate FormulaVariableSlotBound + 12, and a fixed 535-rule eight-token tail in disjoint injective state images. Every raw bitstring reaches exactly FormulaWidth copies of T followed by F, Sep, T, F, T, T, F, T, T, T, F, and Finish; these bits are the canonical encoded-formula prefix through the complete positive clause on variables zero, one, and two. The literal table has exactly 1138 plus the four compiled unary-evaluator rule counts, and its external compiled bound is FirstLiteralPrefix.rawTimeBound + 1158 + 6*Unary.workSteps(nextTokenSlotPolynomial) + 192*n + 96*width. Its 77 public declarations use only propext and Quot.sound, never Classical.choice or a project axiom. The combined 78-declaration audit also covers the predecessor halt-separation theorem. This retained coordinate is not a dynamic cursor, and the milestone supplies no remaining formula body, complete builder, RawRefinement, PolynomialReduction, CNFSAT NP-completeness or in-P result, or P = NP theorem.',
...
const EXACT_FIELDS = Object.freeze({
  ...
  publicSurfaceBaselineCoordinate: 'PUBLIC-SURFACE-BASELINE-2026-07-17-COOK-LEVIN-BUILDER-FIRST-CLAUSE-PREFIX-49',
...
function publicationExpected0(publication, inventory, publicationMap, publicationMapSha256, sourceClosureSha256) {
  ...
  return {
    ...
    canonicalReportCoordinate: 'PNP-CANONICAL-FORMAL-RECONSTRUCTION-REPORT-2026-07-17-50',
