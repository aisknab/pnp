...
const VERSION = 0;
const COORDINATE = 'PNP-FORMAL-RECONSTRUCTION-STATUS-2026-07-11-17';
...
const NON_CLAIMS = Object.freeze([
  ...
  'PipelineMachineSimulation simulates any supplied chain of n successful raw step? transitions from an already represented boundary frame in exactly 3 * n successful work transitions, with the endpoint again representing the raw endpoint; ordinary compiled-machine run with fuel 18 * n reaches the encoded work endpoint. These factors are measured in source-transition count, not input length, and the compiled theorem does not assert 18 * n successful transitions. The theorem does not construct a frame from Tape.ofInput, prove boundedDecide, accept/reject, or machineOutput preservation, normalize or hand off terminal output, launch a second stage, provide a FunctionProgram.RawRefinement or DecisionProgram.RawRefinement, compile composition or precomposition, or prove an end-to-end input-size polynomial bound.',
...
const EXACT_FIELDS = Object.freeze({
  ...
  publicSurfaceBaselineCoordinate: 'PUBLIC-SURFACE-BASELINE-2026-07-11-PIPELINE-MULTISTEP-SIMULATION-17',
...
function publicationExpected0(publication, inventory, publicationMap, publicationMapSha256, sourceClosureSha256) {
  ...
  return {
    ...
    canonicalReportCoordinate: 'PNP-CANONICAL-FORMAL-RECONSTRUCTION-REPORT-2026-07-11-17',
