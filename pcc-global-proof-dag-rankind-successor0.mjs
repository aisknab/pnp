...
const PREDECESSOR_NODE_IDS0 = Object.freeze(
  SEMANTIC_KERNEL_SUPPORTED_RULES_HALL0.map((rule) => `K.${rule}`),
);

export const GLOBAL_DAG_RANKIND_SUCCESSOR_PURPOSES0 = Object.freeze([
  'development',
  'final-theorem',
]);

export const GLOBAL_DAG_RANKIND_SUCCESSOR_POLICY0 = Object.freeze({
  kind: 'GlobalProofDAGSemanticRankIndReleasePolicy0',
  version: CHECKER_VERSION,
  semanticKBundleInputMustRemainDevelopmentPurpose: true,
  predecessorGlobalGateMustRemainDevelopmentOnly: true,
  predecessorGlobalGateCannotImplyRankIndReadiness: true,
...
export const GLOBAL_DAG_RANKIND_SUCCESSOR_BINDING0 = Object.freeze({
  kind: 'GlobalProofDAGSemanticRankIndCheckerBinding0',
  version: CHECKER_VERSION,
  predecessorGlobalChecker: 'CheckGlobalProofDAGHallSuccessor0',
  semanticKBundleChecker: 'CheckKBundleRankIndSuccessor0',
  semanticKBundleFinalChecker: 'CheckKBundleRankIndFinalTheoremReadiness0',
});

export function makeGlobalProofDAGRankIndSuccessor0({
  KBundle = makeKBundleRankIndSuccessor0(),
  LegacyGlobalProofDAG = makeSyntheticGlobalProofDAG0(),
  Purpose = 'development',
} = {}) {
  if (!GLOBAL_DAG_RANKIND_SUCCESSOR_PURPOSES0.includes(Purpose)) {
    throw new TypeError(
      `makeGlobalProofDAGRankIndSuccessor0 Purpose must be one of ${GLOBAL_DAG_RANKIND_SUCCESSOR_PURPOSES0.join(', ')}`,
    );
  }

  return {
    kind: 'GlobalProofDAGSemanticRankIndSuccessor0',
    version: CHECKER_VERSION,
    Purpose,
    KBundle,
    LegacyGlobalProofDAG,
    Binding: { ...GLOBAL_DAG_RANKIND_SUCCESSOR_BINDING0 },
    Policy: { ...GLOBAL_DAG_RANKIND_SUCCESSOR_POLICY0 },
  };
}

export async function CheckGlobalProofDAGRankIndSuccessor0(input) {
  return checkGlobalInternal0(input, {
    checker: 'CheckGlobalProofDAGRankIndSuccessor0',
    requiredPurpose: null,
  });
}

export async function CheckGlobalProofDAGRankIndFinalTheoremReadiness0(input) {
  return checkGlobalInternal0(input, {
    checker: 'CheckGlobalProofDAGRankIndFinalTheoremReadiness0',
...
async function checkGlobalInternal0(input, {
  ...
  if (requiredPurpose !== null && input.Purpose !== requiredPurpose) {
    const witness = {
      reason: 'RankInd semantic global-DAG final readiness requires a final-theorem purpose record',
      requiredPurpose,
  ...
  ledger.push(makeLedgerEntry0('purpose', true, {
    kind: 'GlobalProofDAGRankIndPurpose0NF',
    purpose,
  }));
  ...
  const predecessorBundle = makeKBundleHallSuccessor0({
  ...
  const predecessorGlobalInput = makeGlobalProofDAGHallSuccessor0({
  ...
  const predecessorCall = await callChecker0(
    'CheckGlobalProofDAGHallSuccessor0',
    () => CheckGlobalProofDAGHallSuccessor0(predecessorGlobalInput),
  );
  ledger.push(makeLedgerEntry0(
    'CheckGlobalProofDAGHallSuccessor0',
  ...
  if (predecessorRecord.tag !== 'accept') {
    return makeRejectRecord0({
      ...
      path: ['PredecessorGlobal'],
      witness: {
        reason: 'Hall predecessor global gate rejected the ten-rule semantic base',
  ...
  const developmentCall = await callChecker0(
    'CheckKBundleRankIndSuccessor0',
    () => CheckKBundleRankIndSuccessor0(developmentBundleInput),
  );
  ledger.push(makeLedgerEntry0(
    'CheckKBundleRankIndSuccessor0',
  ...
  if (developmentRecord.tag !== 'accept') {
    return makeRejectRecord0({
      ...
      path: ['KBundle'],
      witness: {
        reason: 'RankInd development semantic KBundle rejected',
  ...
  const finalCall = await callChecker0(
    'CheckKBundleRankIndFinalTheoremReadiness0',
    () => CheckKBundleRankIndFinalTheoremReadiness0(finalBundleInput),
  );
  if (!finalCall.ok) {
    ledger.push(makeLedgerEntry0(
      'CheckKBundleRankIndFinalTheoremReadiness0',
  ...
  if (purpose === 'final-theorem' && !gate.finalTheoremReady) {
    return makeRejectRecord0({
      ...
      witness: {
        reason: 'RankInd successor global proof DAG is not ready for final-theorem use',
  ...
  return makeAcceptRecord0({
    checker,
    nf: {
      kind: 'GlobalProofDAGSemanticRankIndSuccessor0NF',
      checker,
      version: CHECKER_VERSION,
      purpose,
...
function validateAndBuildSemanticOverlay0({ dag, bundleNF }) {
  ...
  if (!Array.isArray(nodes)) {
    return validationReject0(
      ...
      'legacy global DAG must expose Nodes for RankInd semantic overlay',
      { actual: typeof nodes },
    );
  }
  ...
  if (!sameCanonical0(
    ...
    return validationReject0(
      ...
      'RankInd global overlay requires the exact expanded semantic rule set',
      {
        expected: [...SEMANTIC_KERNEL_SUPPORTED_RULES_RANKIND0],
  ...
  for (const rule of [...supportedRules, ...missingRules]) {
    if (!nodeById.has(`K.${rule}`)) {
      return validationReject0(
        ...
        'RankInd semantic overlay requires a legacy kernel coordinate for every required primitive rule',
        { rule },
      );
    }
  }
  ...
  for (const id of requiredFinalNodeIds) {
    ...
    if (node === undefined || node.nodeKind !== 'final') {
      return validationReject0(
        ...
        'RankInd semantic overlay requires every legacy final coordinate as a quarantined final node',
  ...
  return validationAccept0({
    kind: 'GlobalProofDAGSemanticRankIndOverlay0NF',
...
function makeComputedGlobalGate0({
  ...
  const nodes = [
    ...
    {
      id: 'Gate.KBundle.RankIndDevelopmentAcceptance',
      premises: ['Gate.PredecessorGlobal.DevelopmentAcceptance'],
      ready: true,
      digest: bundleDevelopmentDigest,
    },
    {
      id: 'Gate.KBundle.RankIndFinalReadiness',
      premises: ['Gate.KBundle.RankIndDevelopmentAcceptance'],
  ...
  const blockers = [
    {
      coordinate: 'KBundle.RankIndFinalReadiness',
      ready: kBundleFinalReady,
      reason: kBundleFinalReady
        ? null
        : 'RankInd successor KBundle semantic readiness remains blocked',
      digest: bundleFinalDigest,
    },
    {
  ...
  return Object.freeze({
    kind: 'GlobalProofDAGComputedSemanticRankIndGate0',
    version: CHECKER_VERSION,
    semanticKBundleComputedReadinessDigest:
...
function validateShape0(input) {
  if (!isPlainObject0(input)) {
    return validationReject0(
      [],
      'RankInd semantic global-DAG input must be an object',
      { actual: typeof input },
    );
  }

  if (input.kind !== 'GlobalProofDAGSemanticRankIndSuccessor0') {
    return validationReject0(
      ['kind'],
      'RankInd semantic global-DAG kind must be GlobalProofDAGSemanticRankIndSuccessor0',
      { actual: input.kind },
    );
  }
  ...
  if (input.version !== CHECKER_VERSION) {
    return validationReject0(
      ['version'],
      `RankInd semantic global-DAG version must be ${CHECKER_VERSION}`,
      { actual: input.version },
    );
  }

  if (!GLOBAL_DAG_RANKIND_SUCCESSOR_PURPOSES0.includes(input.Purpose)) {
    return validationReject0(
      ['Purpose'],
      'RankInd semantic global-DAG Purpose is unsupported',
      {
        actual: input.Purpose,
        supportedPurposes: [...GLOBAL_DAG_RANKIND_SUCCESSOR_PURPOSES0],
      },
    );
  }
  ...
  for (const field of ['KBundle', 'LegacyGlobalProofDAG', 'Binding', 'Policy']) {
    if (!Object.prototype.hasOwnProperty.call(input, field)) {
      return validationReject0(
        [field],
        'RankInd semantic global-DAG input is missing a required field',
        { field },
      );
    }
  }
  ...
  if (!isPlainObject0(input.KBundle)) {
    return validationReject0(
      ['KBundle'],
      'RankInd semantic global-DAG KBundle must be an object',
  ...
  if (input.KBundle.Purpose !== 'development') {
    return validationReject0(
      ['KBundle', 'Purpose'],
      'RankInd semantic global-DAG input KBundle must remain development-purpose; final readiness is recomputed internally',
  ...
  if (!isPlainObject0(input.LegacyGlobalProofDAG)) {
    return validationReject0(
      ['LegacyGlobalProofDAG'],
      'RankInd semantic global-DAG must include a legacy global DAG object',
      { actual: typeof input.LegacyGlobalProofDAG },
    );
  }

  if (!isPlainObject0(input.Binding)
      || !sameCanonical0(input.Binding, GLOBAL_DAG_RANKIND_SUCCESSOR_BINDING0)) {
    return validationReject0(
      ['Binding'],
      'RankInd semantic global-DAG checker binding must match the executable checker boundary',
      {
        expected: GLOBAL_DAG_RANKIND_SUCCESSOR_BINDING0,
  ...
  if (!isPlainObject0(input.Policy)
      || !sameCanonical0(input.Policy, GLOBAL_DAG_RANKIND_SUCCESSOR_POLICY0)) {
    return validationReject0(
      ['Policy'],
      'RankInd semantic global-DAG release policy must match the fail-closed policy',
      {
        expected: GLOBAL_DAG_RANKIND_SUCCESSOR_POLICY0,
        actual: input.Policy,
      },
    );
  }
  ...
  return validationAccept0({
    kind: 'GlobalProofDAGSemanticRankIndSuccessorShape0NF',
...
function validatePredecessorGlobalBoundary0(nf) {
  ...
  for (const [field, value] of Object.entries(expected)) {
    if (nf[field] !== value) {
      return validationReject0(
        ...
        'Hall predecessor global gate did not preserve its development-only boundary',
  ...
  if (!Array.isArray(nf.activeFinalNodeIds)
    ...
    return validationReject0(
      ...
      'Hall predecessor global gate must expose no active final node',
  ...
  if (!sameCanonical0(
    ...
    return validationReject0(
      ...
      'Hall predecessor global semantic-kernel node set mismatch',
      {
  ...
  return validationAccept0({
    kind: 'GlobalProofDAGRankIndPredecessorBoundary0NF',
    ...expected,
    activeFinalNodeIds: [],
...
function validateDevelopmentBundleBoundary0(nf) {
  ...
  for (const [field, value] of Object.entries(expected)) {
    if (nf[field] !== value) {
      return validationReject0(
        ['KBundle', 'NF', field],
        'RankInd semantic KBundle did not preserve its development-only boundary',
        { field, expected: value, actual: nf[field] },
      );
    }
  }
  ...
  if (!sameCanonical0(
    ...
    return validationReject0(
      ['KBundle', 'NF', 'semanticKImplSupportedRules'],
      'RankInd semantic KBundle supported-rule set mismatch',
      {
        expected: [...SEMANTIC_KERNEL_SUPPORTED_RULES_RANKIND0],
  ...
  return validationAccept0({
    kind: 'GlobalProofDAGRankIndKBundleBoundary0NF',
    ...expected,
    semanticKImplSupportedRules: [...SEMANTIC_KERNEL_SUPPORTED_RULES_RANKIND0],
  });
}
...
function extractNodes0(input) {
  if (Array.isArray(input)) {
    return validationAcceptWith0(
      {
        kind: 'GlobalProofDAGRankIndProofInput0NF',
        form: 'array',
