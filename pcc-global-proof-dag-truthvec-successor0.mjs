...
const PREDECESSOR_NODE_IDS0 = Object.freeze(
  SEMANTIC_KERNEL_SUPPORTED_RULES_TRANSPORT0.map(
    (rule) => `K.${rule}`,
  ),
);

export const GLOBAL_DAG_TRUTHVEC_SUCCESSOR_PURPOSES0 = Object.freeze([
  'development',
  'final-theorem',
]);

export const GLOBAL_DAG_TRUTHVEC_SUCCESSOR_POLICY0 = Object.freeze({
  kind: 'GlobalProofDAGSemanticTruthVecReleasePolicy0',
  version: CHECKER_VERSION,
  semanticKBundleInputMustRemainDevelopmentPurpose: true,
  predecessorGlobalGateMustRemainDevelopmentOnly: true,
  predecessorGlobalGateCannotImplyTruthVecReadiness: true,
...
export const GLOBAL_DAG_TRUTHVEC_SUCCESSOR_BINDING0 = Object.freeze({
  kind: 'GlobalProofDAGSemanticTruthVecCheckerBinding0',
  version: CHECKER_VERSION,
  predecessorGlobalChecker: 'CheckGlobalProofDAGTransportSuccessor0',
  semanticKBundleChecker: 'CheckKBundleTruthVecSuccessor0',
  semanticKBundleFinalChecker:
    'CheckKBundleTruthVecFinalTheoremReadiness0',
});

export function makeGlobalProofDAGTruthVecSuccessor0({
  KBundle = makeKBundleTruthVecSuccessor0(),
  LegacyGlobalProofDAG = makeSyntheticGlobalProofDAG0(),
  Purpose = 'development',
} = {}) {
  if (!GLOBAL_DAG_TRUTHVEC_SUCCESSOR_PURPOSES0.includes(Purpose)) {
    throw new TypeError(
      `makeGlobalProofDAGTruthVecSuccessor0 Purpose must be one of ${GLOBAL_DAG_TRUTHVEC_SUCCESSOR_PURPOSES0.join(', ')}`,
    );
  }

  return {
    kind: 'GlobalProofDAGSemanticTruthVecSuccessor0',
    version: CHECKER_VERSION,
    Purpose,
    KBundle,
    LegacyGlobalProofDAG,
    Binding: { ...GLOBAL_DAG_TRUTHVEC_SUCCESSOR_BINDING0 },
    Policy: { ...GLOBAL_DAG_TRUTHVEC_SUCCESSOR_POLICY0 },
  };
}

export async function CheckGlobalProofDAGTruthVecSuccessor0(input) {
  return checkGlobalInternal0(input, {
    checker: 'CheckGlobalProofDAGTruthVecSuccessor0',
    requiredPurpose: null,
  });
}

export async function CheckGlobalProofDAGTruthVecFinalTheoremReadiness0(
  input,
) {
  return checkGlobalInternal0(input, {
    checker: 'CheckGlobalProofDAGTruthVecFinalTheoremReadiness0',
...
async function checkGlobalInternal0(input, {
  ...
  if (requiredPurpose !== null && input.Purpose !== requiredPurpose) {
    const witness = {
      reason: 'TruthVec semantic global-DAG final readiness requires a final-theorem purpose record',
      requiredPurpose,
  ...
  ledger.push(makeLedgerEntry0('purpose', true, {
    kind: 'GlobalProofDAGTruthVecPurpose0NF',
    purpose,
  }));
  ...
  const predecessorBundle = makeKBundleTransportSuccessor0({
  ...
  const predecessorGlobalInput = makeGlobalProofDAGTransportSuccessor0({
  ...
  const predecessorCall = await callChecker0(
    'CheckGlobalProofDAGTransportSuccessor0',
    () => CheckGlobalProofDAGTransportSuccessor0(predecessorGlobalInput),
  );
  ledger.push(makeLedgerEntry0(
    'CheckGlobalProofDAGTransportSuccessor0',
  ...
  if (predecessorRecord.tag !== 'accept') {
    return makeRejectRecord0({
      ...
      path: ['PredecessorGlobal'],
      witness: {
        reason: 'Transport predecessor global gate rejected the fourteen-rule semantic base',
  ...
  if (developmentRecord.tag !== 'accept') {
    return makeRejectRecord0({
      ...
      path: ['KBundle'],
      witness: {
        reason: 'TruthVec development semantic KBundle rejected',
  ...
  if (purpose === 'final-theorem' && !gate.finalTheoremReady) {
    return makeRejectRecord0({
      ...
      witness: {
        reason: 'TruthVec successor global proof DAG is not ready for final-theorem use',
  ...
  return makeAcceptRecord0({
    checker,
    nf: {
      kind: 'GlobalProofDAGSemanticTruthVecSuccessor0NF',
      checker,
      version: CHECKER_VERSION,
      purpose,
...
function validateAndBuildSemanticOverlay0({ dag, bundleNF }) {
  ...
  if (!Array.isArray(nodes)) {
    return validationReject0(
      ...
      'legacy global DAG must expose Nodes for TruthVec semantic overlay',
      { actual: typeof nodes },
    );
  }
  ...
  if (!sameCanonical0(
    ...
    return validationReject0(
      ...
      'TruthVec global overlay requires the exact expanded semantic rule set',
      {
        expected: [...SEMANTIC_KERNEL_SUPPORTED_RULES_TRUTHVEC0],
  ...
  for (const rule of [...supportedRules, ...missingRules]) {
    if (!nodeById.has(`K.${rule}`)) {
      return validationReject0(
        ...
        'TruthVec semantic overlay requires a legacy kernel coordinate for every required primitive rule',
        { rule },
      );
    }
  }
  ...
  for (const id of requiredFinalNodeIds) {
    ...
    if (node === undefined || node.nodeKind !== 'final') {
      return validationReject0(
        ...
        'TruthVec semantic overlay requires every legacy final coordinate as a quarantined final node',
  ...
  return validationAccept0({
    kind: 'GlobalProofDAGSemanticTruthVecOverlay0NF',
...
function makeComputedGlobalGate0({
  ...
  const blockers = [
    Object.freeze({
      coordinate: 'KBundle.TruthVecFinalReadiness',
      ready: kBundleFinalReady,
      reason: kBundleFinalReady
        ? null
        : 'TruthVec successor KBundle semantic readiness remains blocked',
  ...
  return Object.freeze({
    kind: 'GlobalProofDAGComputedSemanticTruthVecGate0',
    version: CHECKER_VERSION,
    semanticKBundleComputedReadinessDigest:
...
function validateShape0(input) {
  if (!isPlainObject0(input)) {
    return validationReject0(
      [],
      'TruthVec semantic global-DAG input must be an object',
      { actual: typeof input },
    );
  }
  if (input.kind !== 'GlobalProofDAGSemanticTruthVecSuccessor0') {
    return validationReject0(
      ['kind'],
      'TruthVec semantic global-DAG kind must be GlobalProofDAGSemanticTruthVecSuccessor0',
      { actual: input.kind },
    );
  }
  if (input.version !== CHECKER_VERSION) {
    return validationReject0(
      ['version'],
      `TruthVec semantic global-DAG version must be ${CHECKER_VERSION}`,
      { actual: input.version },
    );
  }
  if (!GLOBAL_DAG_TRUTHVEC_SUCCESSOR_PURPOSES0.includes(input.Purpose)) {
    return validationReject0(
      ['Purpose'],
      'TruthVec semantic global-DAG Purpose is unsupported',
      {
        actual: input.Purpose,
        supportedPurposes: [...GLOBAL_DAG_TRUTHVEC_SUCCESSOR_PURPOSES0],
      },
    );
  }
  for (const field of ['KBundle', 'LegacyGlobalProofDAG', 'Binding', 'Policy']) {
    if (!Object.prototype.hasOwnProperty.call(input, field)) {
      return validationReject0(
        [field],
        'TruthVec semantic global-DAG input is missing a required field',
        { field },
      );
    }
  }
  if (!isPlainObject0(input.KBundle)) {
    return validationReject0(
      ['KBundle'],
      'TruthVec semantic global-DAG KBundle must be an object',
  ...
  if (input.KBundle.Purpose !== 'development') {
    return validationReject0(
      ['KBundle', 'Purpose'],
      'TruthVec semantic global-DAG input KBundle must remain development-purpose; final readiness is recomputed internally',
  ...
  if (!isPlainObject0(input.LegacyGlobalProofDAG)) {
    return validationReject0(
      ['LegacyGlobalProofDAG'],
      'TruthVec semantic global-DAG must include a legacy global DAG object',
      { actual: typeof input.LegacyGlobalProofDAG },
    );
  }
  if (!isPlainObject0(input.Binding)
      || !sameCanonical0(input.Binding, GLOBAL_DAG_TRUTHVEC_SUCCESSOR_BINDING0)) {
    return validationReject0(
      ['Binding'],
      'TruthVec semantic global-DAG checker binding must match the executable checker boundary',
      {
        expected: GLOBAL_DAG_TRUTHVEC_SUCCESSOR_BINDING0,
        actual: input.Binding,
      },
    );
  }
  if (!isPlainObject0(input.Policy)
      || !sameCanonical0(input.Policy, GLOBAL_DAG_TRUTHVEC_SUCCESSOR_POLICY0)) {
    return validationReject0(
      ['Policy'],
      'TruthVec semantic global-DAG release policy must match the fail-closed policy',
      {
        expected: GLOBAL_DAG_TRUTHVEC_SUCCESSOR_POLICY0,
        actual: input.Policy,
      },
    );
  }
  ...
  return validationAccept0({
    kind: 'GlobalProofDAGSemanticTruthVecSuccessorShape0NF',
...
function validatePredecessorGlobalBoundary0(nf) {
  ...
  for (const [field, value] of Object.entries(expected)) {
    if (nf[field] !== value) {
      return validationReject0(
        ...
        'Transport predecessor global gate did not preserve its development-only boundary',
  ...
  if (!Array.isArray(nf.activeFinalNodeIds)
    ...
    return validationReject0(
      ...
      'Transport predecessor global gate must expose no active final node',
  ...
  if (!sameCanonical0(
    ...
    return validationReject0(
      ...
      'Transport predecessor global semantic-kernel node set mismatch',
      {
  ...
  return validationAccept0({
    kind: 'GlobalProofDAGTruthVecPredecessorBoundary0NF',
    ...expected,
    activeFinalNodeIds: [],
...
function validateDevelopmentBundleBoundary0(nf) {
  ...
  for (const [field, value] of Object.entries(expected)) {
    if (nf[field] !== value) {
      return validationReject0(
        ['KBundle', 'NF', field],
        'TruthVec semantic KBundle did not preserve its development-only boundary',
        { field, expected: value, actual: nf[field] },
      );
    }
  }
  if (!sameCanonical0(
    ...
    return validationReject0(
      ['KBundle', 'NF', 'semanticKImplSupportedRules'],
      'TruthVec semantic KBundle supported-rule set mismatch',
      {
        expected: [...SEMANTIC_KERNEL_SUPPORTED_RULES_TRUTHVEC0],
  ...
  return validationAccept0({
    kind: 'GlobalProofDAGTruthVecKBundleBoundary0NF',
    ...expected,
    semanticKImplSupportedRules: [...SEMANTIC_KERNEL_SUPPORTED_RULES_TRUTHVEC0],
  });
}
...
function extractNodes0(input) {
  if (Array.isArray(input)) {
    return validationAcceptWith0(
      {
        kind: 'GlobalProofDAGTruthVecProofInput0NF',
        form: 'array',
