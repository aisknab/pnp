...
export function makeSyntheticGPack0(overrides = {}) {
  ...
  const gpack = {
    ...
    ThresholdCert: {
      ...
      unsatTracePredicateIdenticallyFalse: true,
      unsatFinalOutputIdenticallyZero: true,
      zeroOutputCoordinateFree: true,
      repeatedOutputCoordinatesFree: true,
      multiOutputGateCountOnly: true,
      unsatFinalCoordinateAddsNoGate: true,
      unsatMinEqualsBaselineByZeroOutput: true,
      finalLockSeparation: true,
      satWitnessMakesTraceAndOutputOne: true,
      finalLockFreshOnlyFinal: true,
      finalOutputEssentiallyDependsOnZ: true,
      baselineOutputsDoNotMentionZ: true,
      finalOutputNonconstant: true,
      finalOutputNonprojection: true,
      finalOutputDistinctFromBaseline: true,
      satLowerBoundExtraGateByFinalLock: true,
  ...
  return [
    ...
    },
    {
      ...
      payload: {
        ...
        unsatTracePredicateIdenticallyFalse:
          thresholdDerivation.unsatTracePredicateIdenticallyFalse,
        unsatFinalOutputIdenticallyZero:
          thresholdDerivation.unsatFinalOutputIdenticallyZero,
        zeroOutputCoordinateFree: thresholdDerivation.zeroOutputCoordinateFree,
        repeatedOutputCoordinatesFree:
          thresholdDerivation.repeatedOutputCoordinatesFree,
        multiOutputGateCountOnly: thresholdDerivation.multiOutputGateCountOnly,
        unsatFinalCoordinateAddsNoGate:
          thresholdDerivation.unsatFinalCoordinateAddsNoGate,
        unsatMinEqualsBaselineByZeroOutput:
          thresholdDerivation.unsatMinEqualsBaselineByZeroOutput,
        finalLockSeparation: thresholdDerivation.finalLockSeparation,
        satWitnessMakesTraceAndOutputOne:
          thresholdDerivation.satWitnessMakesTraceAndOutputOne,
        finalLockFreshOnlyFinal: thresholdDerivation.finalLockFreshOnlyFinal,
        finalOutputEssentiallyDependsOnZ:
          thresholdDerivation.finalOutputEssentiallyDependsOnZ,
        baselineOutputsDoNotMentionZ:
          thresholdDerivation.baselineOutputsDoNotMentionZ,
        finalOutputNonconstant: thresholdDerivation.finalOutputNonconstant,
        finalOutputNonprojection: thresholdDerivation.finalOutputNonprojection,
        finalOutputDistinctFromBaseline:
          thresholdDerivation.finalOutputDistinctFromBaseline,
        satLowerBoundExtraGateByFinalLock:
          thresholdDerivation.satLowerBoundExtraGateByFinalLock,
...
function validateThresholdCertHardened0(gpack) {
  ...
  for (const field of [
    ...
    'unsatTracePredicateIdenticallyFalse',
    'unsatFinalOutputIdenticallyZero',
    'zeroOutputCoordinateFree',
    'repeatedOutputCoordinatesFree',
    'multiOutputGateCountOnly',
    'unsatFinalCoordinateAddsNoGate',
    'unsatMinEqualsBaselineByZeroOutput',
    'finalLockSeparation',
    'satWitnessMakesTraceAndOutputOne',
    'finalLockFreshOnlyFinal',
    'finalOutputEssentiallyDependsOnZ',
    'baselineOutputsDoNotMentionZ',
    'finalOutputNonconstant',
    'finalOutputNonprojection',
    'finalOutputDistinctFromBaseline',
    'satLowerBoundExtraGateByFinalLock',
  ]) {
    if (cert[field] !== true) {
