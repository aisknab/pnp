...
export const KBUNDLE_MINCOUNTEREXAMPLE_SUCCESSOR_PURPOSES0 = Object.freeze([
  'development',
  'final-theorem',
]);

export const KBUNDLE_MINCOUNTEREXAMPLE_SUCCESSOR_POLICY0 = Object.freeze({
  kind: 'KBundleSemanticMinCounterexampleReleasePolicy0',
  version: CHECKER_VERSION,
  semanticKImplInputMustRemainDevelopmentPurpose: true,
  predecessorKBundleMustRemainDevelopmentOnly: true,
  predecessorKBundleCannotImplyMinCounterexampleReadiness: true,
...
export const KBUNDLE_MINCOUNTEREXAMPLE_SUCCESSOR_BINDING0 = Object.freeze({
  kind: 'KBundleSemanticMinCounterexampleCheckerBinding0',
  version: CHECKER_VERSION,
  predecessorKBundleChecker: 'CheckKBundleRankIndSuccessor0',
  semanticKImplChecker: 'CheckKImplMinCounterexampleSuccessor0',
  semanticKImplFinalChecker:
    'CheckKImplMinCounterexampleFinalTheoremReadiness0',
});

export function makeKBundleMinCounterexampleSuccessor0({
  ...
  if (!KBUNDLE_MINCOUNTEREXAMPLE_SUCCESSOR_PURPOSES0.includes(Purpose)) {
    throw new TypeError(
      `makeKBundleMinCounterexampleSuccessor0 Purpose must be one of ${KBUNDLE_MINCOUNTEREXAMPLE_SUCCESSOR_PURPOSES0.join(', ')}`,
    );
  }

  return {
    kind: 'KBundleSemanticMinCounterexampleSuccessor0',
    version: CHECKER_VERSION,
    Purpose,
    SemanticKImpl: makeKImplMinCounterexampleSuccessor0({
      KImpl,
      SemanticProofDAG,
      Purpose: 'development',
    }),
    ...
    PSigma,
    ReflectionRegistry,
    Binding: { ...KBUNDLE_MINCOUNTEREXAMPLE_SUCCESSOR_BINDING0 },
    Policy: { ...KBUNDLE_MINCOUNTEREXAMPLE_SUCCESSOR_POLICY0 },
  };
}

export async function CheckKBundleMinCounterexampleSuccessor0(input) {
  return checkKBundleInternal0(input, {
    checker: 'CheckKBundleMinCounterexampleSuccessor0',
    requiredPurpose: null,
  });
}

export async function CheckKBundleMinCounterexampleFinalTheoremReadiness0(input) {
  return checkKBundleInternal0(input, {
    checker: 'CheckKBundleMinCounterexampleFinalTheoremReadiness0',
...
async function checkKBundleInternal0(input, {
  ...
  if (requiredPurpose !== null && input.Purpose !== requiredPurpose) {
    const witness = {
      reason: 'MinCounterexample semantic KBundle final readiness requires a final-theorem purpose record',
      requiredPurpose,
  ...
  ledger.push(makeLedgerEntry0('purpose', true, {
    kind: 'KBundleMinCounterexamplePurpose0NF',
    purpose,
  }));
  ...
  const predecessorBundleInput = makeKBundleRankIndSuccessor0({
  ...
  const predecessorCall = await callChecker0(
    'CheckKBundleRankIndSuccessor0',
    () => CheckKBundleRankIndSuccessor0(predecessorBundleInput),
  );
  ledger.push(makeLedgerEntry0(
    'CheckKBundleRankIndSuccessor0',
  ...
  if (predecessorRecord.tag !== 'accept') {
    return makeRejectRecord0({
      ...
      path: ['PredecessorKBundle'],
      witness: {
        reason: 'RankInd predecessor KBundle rejected the eleven-rule semantic base',
  ...
  const developmentCall = await callChecker0(
    'CheckKImplMinCounterexampleSuccessor0',
    () => CheckKImplMinCounterexampleSuccessor0(developmentKImplInput),
  );
  ledger.push(makeLedgerEntry0(
    'CheckKImplMinCounterexampleSuccessor0',
  ...
  if (developmentRecord.tag !== 'accept') {
    return makeRejectRecord0({
      ...
      path: ['SemanticKImpl'],
      witness: {
        reason: 'MinCounterexample development semantic KImpl successor rejected',
  ...
  const finalCall = await callChecker0(
    'CheckKImplMinCounterexampleFinalTheoremReadiness0',
    () => CheckKImplMinCounterexampleFinalTheoremReadiness0(finalKImplInput),
  );
  if (!finalCall.ok) {
    ledger.push(makeLedgerEntry0(
      'CheckKImplMinCounterexampleFinalTheoremReadiness0',
  ...
  if (purpose === 'final-theorem' && !readiness.finalTheoremReady) {
    return makeRejectRecord0({
      ...
      witness: {
        reason: 'MinCounterexample semantic KBundle is not ready for final-theorem use',
  ...
  return makeAcceptRecord0({
    checker,
    nf: {
      kind: 'KBundleSemanticMinCounterexampleSuccessor0NF',
      checker,
      version: CHECKER_VERSION,
      purpose,
      ...
      semanticMinCounterexampleNodeCount:
        developmentNF.semanticMinCounterexampleNodeCount ?? null,
...
function makeComputedReadiness0({
  ...
  const blockers = [
    {
      ...
      checker: 'CheckKImplMinCounterexampleFinalTheoremReadiness0',
      reason: semanticKImplFinalReady
        ? null
        : 'semantic primitive-rule coverage remains incomplete after MinCounterexample',
  ...
  return Object.freeze({
    kind: 'KBundleComputedSemanticMinCounterexampleReadiness0',
    version: CHECKER_VERSION,
    semanticKImplFinalReady,
    semanticConformanceReady: false,
    semanticSigmaReady: false,
...
function validateShape0(input) {
  if (!isPlainObject0(input)) {
    return validationReject0(
      [],
      'MinCounterexample semantic KBundle input must be an object',
      { actual: typeof input },
    );
  }

  if (input.kind !== 'KBundleSemanticMinCounterexampleSuccessor0') {
    return validationReject0(
      ['kind'],
  ...
  if (input.version !== CHECKER_VERSION) {
    return validationReject0(
      ['version'],
      `MinCounterexample semantic KBundle version must be ${CHECKER_VERSION}`,
      { actual: input.version },
    );
  }

  if (!KBUNDLE_MINCOUNTEREXAMPLE_SUCCESSOR_PURPOSES0.includes(input.Purpose)) {
    return validationReject0(
      ['Purpose'],
      'MinCounterexample semantic KBundle Purpose is unsupported',
      {
        actual: input.Purpose,
        supportedPurposes: [
          ...KBUNDLE_MINCOUNTEREXAMPLE_SUCCESSOR_PURPOSES0,
        ],
      },
    );
  }
  ...
  for (const field of [
    ...
    if (!Object.prototype.hasOwnProperty.call(input, field)) {
      return validationReject0(
        [field],
        'MinCounterexample semantic KBundle is missing a required field',
        { field },
      );
    }
  }
  ...
  if (!isPlainObject0(input.SemanticKImpl)) {
    return validationReject0(
      ['SemanticKImpl'],
      'MinCounterexample semantic KBundle SemanticKImpl must be an object',
  ...
  if (input.SemanticKImpl.Purpose !== 'development') {
    return validationReject0(
      ...
      'MinCounterexample semantic KBundle input KImpl must remain development-purpose; final readiness is recomputed internally',
  ...
  if (!isPlainObject0(input.Binding)
      || !sameCanonical0(
        input.Binding,
        KBUNDLE_MINCOUNTEREXAMPLE_SUCCESSOR_BINDING0,
      )) {
    return validationReject0(
      ['Binding'],
      'MinCounterexample semantic KBundle checker binding must match the executable checker boundary',
      {
        expected: KBUNDLE_MINCOUNTEREXAMPLE_SUCCESSOR_BINDING0,
  ...
  if (!isPlainObject0(input.Policy)
      || !sameCanonical0(
        input.Policy,
        KBUNDLE_MINCOUNTEREXAMPLE_SUCCESSOR_POLICY0,
      )) {
    return validationReject0(
      ['Policy'],
      'MinCounterexample semantic KBundle release policy must match the fail-closed policy',
      {
        expected: KBUNDLE_MINCOUNTEREXAMPLE_SUCCESSOR_POLICY0,
        actual: input.Policy,
      },
    );
  }
  ...
  return validationAccept0({
    kind: 'KBundleSemanticMinCounterexampleSuccessorShape0NF',
...
function validatePredecessorBundleBoundary0(nf) {
  ...
  for (const [field, value] of Object.entries(expected)) {
    if (nf[field] !== value) {
      return validationReject0(
        ...
        'RankInd predecessor KBundle did not preserve its development-only boundary',
  ...
  if (!sameCanonical0(
    ...
    return validationReject0(
      ...
      'RankInd predecessor KBundle semantic rule set mismatch',
      {
  ...
  return validationAccept0({
    kind: 'KBundleMinCounterexamplePredecessorBoundary0NF',
    ...expected,
...
function validateDevelopmentKImplBoundary0(nf) {
  ...
  for (const [field, value] of Object.entries(expected)) {
    if (nf[field] !== value) {
      return validationReject0(
        ...
        'MinCounterexample semantic KImpl did not preserve its development-only boundary',
        { field, expected: value, actual: nf[field] },
      );
    }
  }
  ...
  if (!sameCanonical0(
    ...
    return validationReject0(
      ...
      'MinCounterexample semantic KImpl supported-rule set mismatch',
      {
        expected: [
          ...SEMANTIC_KERNEL_SUPPORTED_RULES_MINCOUNTEREXAMPLE0,
        ],
  ...
  return validationAccept0({
    kind: 'KBundleMinCounterexampleKImplDevelopmentBoundary0NF',
    ...expected,
...
function extractNodes0(input) {
  if (Array.isArray(input)) {
    return validationAcceptWith0(
      {
        kind: 'KBundleMinCounterexampleProofInput0NF',
        form: 'array',
