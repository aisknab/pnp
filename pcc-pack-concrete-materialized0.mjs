...
export function summarizeConcretePCCPackCoverage0(materializedPCCPackEnvelope) {
  ...
  return {
    ...
    globalProofDAGHasGThresholdProofNode: finalIntegrationLinks?.globalProofDAGHasGThresholdProofNode === true,
    globalProofDAGPackageGDependsOnGThresholdProof: finalIntegrationLinks?.globalProofDAGPackageGDependsOnGThresholdProof === true,
    globalProofDAGFinalSATinPDependsOnPackageG: finalIntegrationLinks?.globalProofDAGFinalSATinPDependsOnPackageG === true,
    finalIntegrationGlobalGLinkageComplete: finalIntegrationLinks?.finalIntegrationGlobalGLinkageComplete === true,
    finalTheoremGLinkageComplete: finalIntegrationLinks?.finalTheoremGLinkageComplete === true,
    finalTheoremUsesGlobalGThreshold: finalIntegrationLinks?.finalTheoremUsesGlobalGThreshold === true,
    finalTheoremUsesGThresholdProofRef: finalIntegrationLinks?.finalTheoremUsesGThresholdProofRef === true,
    finalTheoremUsesFinalIntegrationGlobalGLinkage: finalIntegrationLinks?.finalTheoremUsesFinalIntegrationGlobalGLinkage === true,
...
export async function CheckConcreteMaterializedPCCPack0(
  ...
  const nf = {
    ...
    finalIntegrationUsesGPack: recomputedCoverage.finalIntegrationUsesGPack,
    rowFamGUsesGPack: recomputedCoverage.rowFamGUsesGPack,
    finalTheoremUsesFinalIntegration: recomputedCoverage.finalTheoremUsesFinalIntegration,
    rowFamFinalUsesFinalTheorem: recomputedCoverage.rowFamFinalUsesFinalTheorem,
    finalMatchUsesGPack: recomputedCoverage.finalMatchUsesGPack,
    satDecisionUsesGPack: recomputedCoverage.satDecisionUsesGPack,
    globalProofDAGHasGThresholdProofNode: recomputedCoverage.globalProofDAGHasGThresholdProofNode,
    globalProofDAGPackageGDependsOnGThresholdProof: recomputedCoverage.globalProofDAGPackageGDependsOnGThresholdProof,
    globalProofDAGFinalSATinPDependsOnPackageG: recomputedCoverage.globalProofDAGFinalSATinPDependsOnPackageG,
    finalIntegrationGlobalGLinkageComplete: recomputedCoverage.finalIntegrationGlobalGLinkageComplete,
    finalTheoremGLinkageComplete: recomputedCoverage.finalTheoremGLinkageComplete,
    finalTheoremUsesGlobalGThreshold: recomputedCoverage.finalTheoremUsesGlobalGThreshold,
    finalTheoremUsesGThresholdProofRef: recomputedCoverage.finalTheoremUsesGThresholdProofRef,
    finalTheoremUsesFinalIntegrationGlobalGLinkage: recomputedCoverage.finalTheoremUsesFinalIntegrationGlobalGLinkage,
