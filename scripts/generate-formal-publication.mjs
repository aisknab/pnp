...
const STATUS_COORDINATE = 'PNP-FORMAL-RECONSTRUCTION-STATUS-2026-07-11-17';
const PUBLIC_SURFACE_COORDINATE = 'PUBLIC-SURFACE-BASELINE-2026-07-11-PIPELINE-MULTISTEP-SIMULATION-17';
const REPORT_COORDINATE = 'PNP-CANONICAL-FORMAL-RECONSTRUCTION-REPORT-2026-07-11-17';
...
export async function BuildFormalPublication0(root) {
  ...
  if (publication.gate.passed !== false) throw new Error('Release-17 publication gate must remain intentionally fail-closed');
