...
const STATUS_COORDINATE = 'PNP-FORMAL-RECONSTRUCTION-STATUS-2026-07-11-16';
const PUBLIC_SURFACE_COORDINATE = 'PUBLIC-SURFACE-BASELINE-2026-07-11-PIPELINE-MACHINE-SIMULATION-16';
const REPORT_COORDINATE = 'PNP-CANONICAL-FORMAL-RECONSTRUCTION-REPORT-2026-07-11-16';
...
export async function BuildFormalPublication0(root) {
  ...
  if (publication.gate.passed !== false) throw new Error('Release-16 publication gate must remain intentionally fail-closed');
