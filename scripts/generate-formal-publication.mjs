...
const STATUS_COORDINATE = 'PNP-FORMAL-RECONSTRUCTION-STATUS-2026-07-11-13';
const PUBLIC_SURFACE_COORDINATE = 'PUBLIC-SURFACE-BASELINE-2026-07-11-PIPELINE-REFINEMENT-13';
const REPORT_COORDINATE = 'PNP-CANONICAL-FORMAL-RECONSTRUCTION-REPORT-2026-07-11-13';
...
export async function BuildFormalPublication0(root) {
  ...
  if (publication.gate.passed !== false) throw new Error('Release-13 publication gate must remain intentionally fail-closed');
