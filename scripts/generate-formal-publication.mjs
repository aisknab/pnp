...
const REPORT_COORDINATE = 'PNP-CANONICAL-FORMAL-RECONSTRUCTION-REPORT-2026-08-05-103';
...
export async function BuildFormalPublication0(root) {
  ...
  if (publication.gate.passed !== false) throw new Error('Release-83 publication gate must remain intentionally fail-closed');
