...
const NODE_SYNTAX_TARGETS = [
  ...
  'pcc-direct-bind-charge-ledger0.mjs', 'pcc-direct-bind-mode-firewall0.mjs', 'semantics/nand-direct-wire-reference.mjs', 'semantics/nand-small-models.mjs',
  'semantics/locked-nand-sat-small-models.mjs', 'scripts/cross-verify.mjs', 'scripts/audit-report-theorem-bindings.mjs',
  'scripts/audit-independent-verifiers-no-shared-code.mjs', 'scripts/audit-checker-totality.mjs', 'scripts/audit-negative-checker-mutations.mjs',
  'scripts/generate-checker-dependency-graph.mjs', 'scripts/audit-checker-cycles.mjs', 'scripts/audit-no-hidden-oracle.mjs',
  'scripts/audit-determinism.mjs', 'scripts/audit-regeneration-ledger.mjs', 'scripts/pnp-verify-all.mjs',
];
