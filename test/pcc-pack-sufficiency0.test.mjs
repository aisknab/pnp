...
test('CheckPackSufficiency0 rejects missing BN2 side-tight coherent optima obligations', async (t) => {
  const cases = [
...
test('CheckPackSufficiency0 rejects missing BN3 finite request-envelope obligations', async (t) => {
  const cases = [
...
test('CheckPackSufficiency0 rejects missing BN5 and PkgC localization obligations', async (t) => {
  const cases = [
...
test('CheckPackSufficiency0 rejects missing BN6 packet-collapse and selector-completeness obligations', async (t) => {
  const cases = [
...
test('CheckPackSufficiency0 rejects missing Realizer and HB closure obligations', async (t) => {
  const cases = [
    'realizerBotTyped',
    'realizerBotOnlyHNBUDBlockedOrLowerRank',
