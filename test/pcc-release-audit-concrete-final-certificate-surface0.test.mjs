...
function makeAcceptedConcreteFinalCertificatePublicStatusRecord0() {
  const nf = {
    ...
    generatedPCCPackexpConcreteHard0: true,
    generatedPCCPackexpConcreteHard0Accepted: true,
    generatedPCCPackexpConcreteHard0Checker: 'CheckConcreteMaterializedHard0',
    generatedPCCPackexpConcreteHard0Digest: digestOf0('32'.repeat(32)),
    generatedPCCPackexpConcreteHard0MaterializedHardDigest: digestOf0('33'.repeat(32)),
    generatedPCCPackexpConcreteHard0HardCheckDigest: digestOf0('34'.repeat(32)),
    generatedPCCPackexpConcreteHard0CoverageDigest: digestOf0('35'.repeat(32)),
    generatedPCCPackexpConcreteHard0CheckerCount: 13,
    generatedPCCPackexpConcreteHard0CheckerCoverageComplete: true,
    generatedPCCPackexpConcreteHard0RowKeyFieldCount: 17,
    generatedPCCPackexpConcreteHard0RowKeyCoverageComplete: true,
    generatedPCCPackexpConcreteHard0RoutePriorityComplete: true,
    generatedPCCPackexpConcreteHard0ProofRefPolicyComplete: true,
    generatedPCCPackexpConcreteHard0HashDisciplineComplete: true,
    generatedPCCPackexpConcreteHard0NoMinCoverageComplete: true,
    generatedPCCPackexpConcreteHard0ForbiddenSymbolCount: 11,
    generatedPCCPackexpConcreteHard0ImportPolicyComplete: true,
    generatedPCCPackexpConcreteHard0ForbiddenImportEdgeCount: 6,
    generatedPCCPackexpConcreteHard0ReflectionPolicyComplete: true,
    ...
    generatedPCCPackexpConcreteGlobalProofDAG0: true,
    generatedPCCPackexpConcreteGlobalProofDAG0Accepted: true,
    generatedPCCPackexpConcreteGlobalProofDAG0Checker: 'CheckConcreteMaterializedGlobalProofDAG0',
    generatedPCCPackexpConcreteGlobalProofDAG0Digest: digestOf0('3c'.repeat(32)),
    generatedPCCPackexpConcreteGlobalProofDAG0GlobalProofDAGDigest: digestOf0('3d'.repeat(32)),
    generatedPCCPackexpConcreteGlobalProofDAG0GlobalProofDAGObjectDigest: digestOf0('3e'.repeat(32)),
    generatedPCCPackexpConcreteGlobalProofDAG0MaterializedGlobalProofDAGDigest: digestOf0('3f'.repeat(32)),
    generatedPCCPackexpConcreteGlobalProofDAG0KImplDigest: digestOf0('40'.repeat(32)),
    generatedPCCPackexpConcreteGlobalProofDAG0RowPackDigest: digestOf0('41'.repeat(32)),
    generatedPCCPackexpConcreteGlobalProofDAG0LocalPackagesDigest: digestOf0('42'.repeat(32)),
    generatedPCCPackexpConcreteGlobalProofDAG0GlobalFirewallsDigest: digestOf0('43'.repeat(32)),
    generatedPCCPackexpConcreteGlobalProofDAG0KBundleProofInventoryDigest: digestOf0('44'.repeat(32)),
    generatedPCCPackexpConcreteGlobalProofDAG0KBundleKernelRuleCoverageComplete: true,
    generatedPCCPackexpConcreteGlobalProofDAG0KBundleSigmaProofRefsResolve: true,
    generatedPCCPackexpConcreteGlobalProofDAG0KBundleReflectionProofRefsResolve: true,
    generatedPCCPackexpConcreteGlobalProofDAG0NodeCount: 96,
    generatedPCCPackexpConcreteGlobalProofDAG0NodeCountMinimum: true,
    generatedPCCPackexpConcreteGlobalProofDAG0FinalTheoremCount: 4,
    generatedPCCPackexpConcreteGlobalProofDAG0FinalPackageSoundness: true,
    generatedPCCPackexpConcreteGlobalProofDAG0FinalGeneratedPackageSufficiency: true,
    generatedPCCPackexpConcreteGlobalProofDAG0FinalAcceptedPackageImpliesSATinP: true,
    generatedPCCPackexpConcreteGlobalProofDAG0FinalAcceptedPackageImpliesPEqualsNP: true,
    generatedPCCPackexpConcreteGlobalProofDAG0IfaceHash: digestOf0('45'.repeat(32)),
    generatedPCCPackexpConcreteGlobalProofDAG0SchedHash: digestOf0('46'.repeat(32)),
    generatedPCCPackexpConcreteGlobalProofDAG0IfaceMatchesRows: true,
    generatedPCCPackexpConcreteGlobalProofDAG0SchedMatchesKImpl: true,
    generatedPCCPackexpConcreteGlobalProofDAG0SyntheticMarkerCount: 0,
    generatedPCCPackexpConcreteGlobalProofDAG0ForbiddenMarkerCount: 0,
    generatedPCCPackexpConcreteGlobalProofDAG0NoForbiddenMarkers: true,
    generatedPCCPackexpConcreteGlobalProofDAG0LinkedToGeneratedBoot0: true,
    generatedPCCPackexpConcreteGlobalProofDAG0LinkedToKImpl: true,
    generatedPCCPackexpConcreteGlobalProofDAG0LinkedToConcreteRows: true,
    generatedPCCPackexpConcreteGlobalProofDAG0LinkedToLocalPackages: true,
    generatedPCCPackexpConcreteGlobalProofDAG0LinkedToGlobalFirewalls: true,
    generatedPCCPackexpConcreteGlobalProofDAG0LinkedToPCCPack: true,
    generatedPCCPackexpConcreteFinalIntegration0: true,
    generatedPCCPackexpConcreteFinalIntegration0Accepted: true,
    generatedPCCPackexpConcreteFinalIntegration0Checker: 'CheckConcreteMaterializedFinalIntegration0',
    generatedPCCPackexpConcreteFinalIntegration0Digest: digestOf0('47'.repeat(32)),
    generatedPCCPackexpConcreteFinalIntegration0ConcreteGlobalProofDAGDigest: digestOf0('48'.repeat(32)),
    generatedPCCPackexpConcreteFinalIntegration0MaterializedFinalIntegrationDigest: digestOf0('49'.repeat(32)),
    generatedPCCPackexpConcreteFinalIntegration0GPackDigest: digestOf0('4a'.repeat(32)),
    generatedPCCPackexpConcreteFinalIntegration0RowFamGDigest: digestOf0('4b'.repeat(32)),
    generatedPCCPackexpConcreteFinalIntegration0FinalIntegrationDigest: digestOf0('4c'.repeat(32)),
    generatedPCCPackexpConcreteFinalIntegration0FinalTheoremDigest: digestOf0('4d'.repeat(32)),
    generatedPCCPackexpConcreteFinalIntegration0RowFamFinalDigest: digestOf0('4e'.repeat(32)),
    generatedPCCPackexpConcreteFinalIntegration0ConcreteLinksDigest: digestOf0('4f'.repeat(32)),
    generatedPCCPackexpConcreteFinalIntegration0ConcreteGlobalProofDAG: true,
    generatedPCCPackexpConcreteFinalIntegration0ConcreteKBundle: true,
    generatedPCCPackexpConcreteFinalIntegration0ConcreteRows: true,
    generatedPCCPackexpConcreteFinalIntegration0ConcreteLocalPackages: true,
    generatedPCCPackexpConcreteFinalIntegration0ConcreteGlobalFirewalls: true,
    generatedPCCPackexpConcreteFinalIntegration0KBundleKernelRuleCoverageComplete: true,
    generatedPCCPackexpConcreteFinalIntegration0KBundleSigmaProofRefsResolve: true,
    generatedPCCPackexpConcreteFinalIntegration0KBundleReflectionProofRefsResolve: true,
    generatedPCCPackexpConcreteFinalIntegration0GPackFieldCoverageComplete: true,
    generatedPCCPackexpConcreteFinalIntegration0RowFamGCoverageComplete: true,
    generatedPCCPackexpConcreteFinalIntegration0FinalIntegrationUsesGPack: true,
    generatedPCCPackexpConcreteFinalIntegration0RowFamGUsesGPack: true,
    generatedPCCPackexpConcreteFinalIntegration0FinalTheoremUsesFinalIntegration: true,
    generatedPCCPackexpConcreteFinalIntegration0RowFamFinalUsesFinalTheorem: true,
    generatedPCCPackexpConcreteFinalIntegration0FinalMatchUsesGPack: true,
    generatedPCCPackexpConcreteFinalIntegration0SATDecisionUsesGPack: true,
    generatedPCCPackexpConcreteFinalIntegration0SyntheticMarkerCount: 0,
    generatedPCCPackexpConcreteFinalIntegration0ForbiddenMarkerCount: 0,
    generatedPCCPackexpConcreteFinalIntegration0NoForbiddenMarkers: true,
    generatedPCCPackexpConcreteFinalIntegration0LinkedToGeneratedGlobalProofDAG: true,
    generatedPCCPackexpConcreteFinalIntegration0LinkedToGPack: true,
    generatedPCCPackexpConcreteFinalIntegration0LinkedToRowFamG: true,
    generatedPCCPackexpConcreteFinalIntegration0LinkedToFinalIntegration: true,
    generatedPCCPackexpConcreteFinalIntegration0LinkedToFinalTheorem: true,
    generatedPCCPackexpConcreteFinalIntegration0LinkedToRowFamFinal: true,
    generatedPCCPackexpConcreteFinalIntegration0LinkedToPCCPack: true,
    generatedPCCPackexpCheckPCCPackexp0: true,
    generatedPCCPackexpCheckPCCPackexp0Accepted: true,
    generatedPCCPackexpCheckPCCPackexp0Checker: 'CheckPCCPackexp0',
    generatedPCCPackexpCheckPCCPackexp0Digest: digestOf0('50'.repeat(32)),
    generatedPCCPackexpCheckPCCPackexp0MaterializedPath: true,
    generatedPCCPackexpCheckPCCPackexp0SyntheticRunAll: true,
    generatedPCCPackexpCheckPCCPackexp0PackageKind: 'PCCPack0',
    generatedPCCPackexpCheckPCCPackexp0MaterializedPCCPackKind: 'MaterializedPCCPack0',
    generatedPCCPackexpCheckPCCPackexp0PCCPackDigest: digestOf0('51'.repeat(32)),
    generatedPCCPackexpCheckPCCPackexp0MaterializedPCCPackDigest: digestOf0('52'.repeat(32)),
    generatedPCCPackexpCheckPCCPackexp0ConcretePCCPackRecordDigest: digestOf0('53'.repeat(32)),
    generatedPCCPackexpCheckPCCPackexp0ConcreteCoverageDigest: digestOf0('54'.repeat(32)),
    generatedPCCPackexpCheckPCCPackexp0PublicConclusionOnlyAfterAcceptRun: true,
    generatedPCCPackexpCheckPCCPackexp0PublicConclusionEmitted: true,
    generatedPCCPackexpCheckPCCPackexp0NoPrematurePublicConclusion: true,
    generatedPCCPackexpCheckPCCPackexp0ClaimBoundaryConditional: true,
    generatedPCCPackexpCheckPCCPackexp0ClaimBoundaryAntecedent: 'CheckPCCPackexp(GeneratePCCPack())=accept',
    generatedPCCPackexpCheckPCCPackexp0ClaimBoundaryConsequent: 'P = NP',
    generatedPCCPackexpCheckPCCPackexp0GeneratedPackageImplication: true,
    generatedPCCPackexpCheckPCCPackexp0ConcretePCCPack: true,
    generatedPCCPackexpCheckPCCPackexp0ConcreteKBundle: true,
    generatedPCCPackexpCheckPCCPackexp0ConcreteHardCheck: true,
    generatedPCCPackexpCheckPCCPackexp0ConcreteRows: true,
    generatedPCCPackexpCheckPCCPackexp0ConcreteLocalPackages: true,
    generatedPCCPackexpCheckPCCPackexp0ConcreteGlobalFirewalls: true,
    generatedPCCPackexpCheckPCCPackexp0ConcreteGlobalProofDAG: true,
    generatedPCCPackexpCheckPCCPackexp0ConcreteFinalIntegration: true,
    generatedPCCPackexpCheckPCCPackexp0KBundleCoverageComplete: true,
    generatedPCCPackexpCheckPCCPackexp0HardCoverageComplete: true,
    generatedPCCPackexpCheckPCCPackexp0FinalIntegrationCoverageComplete: true,
    generatedPCCPackexpCheckPCCPackexp0PCCPackLinkedToKBundle: true,
    generatedPCCPackexpCheckPCCPackexp0PCCPackLinkedToHardCheck: true,
    generatedPCCPackexpCheckPCCPackexp0PCCPackLinkedToRows: true,
    generatedPCCPackexpCheckPCCPackexp0PCCPackLinkedToLocalPackages: true,
    generatedPCCPackexpCheckPCCPackexp0PCCPackLinkedToGlobalFirewalls: true,
    generatedPCCPackexpCheckPCCPackexp0PCCPackLinkedToGlobalProofDAG: true,
    generatedPCCPackexpCheckPCCPackexp0PCCPackLinkedToGPack: true,
    generatedPCCPackexpCheckPCCPackexp0PCCPackLinkedToFinalIntegration: true,
    generatedPCCPackexpCheckPCCPackexp0PCCPackLinkedToFinalTheorem: true,
    generatedPCCPackexpCheckPCCPackexp0PCCPackLinkageComplete: true,
    generatedPCCPackexpCheckPCCPackexp0ConcreteCoverageComplete: true,
    generatedPCCPackexpCheckPCCPackexp0ConcretePCCPackRecordKind: 'ConcreteMaterializedPCCPack0NF',
    generatedPCCPackexpCheckPCCPackexp0ConcretePCCPackRecordAccepted: true,
...
test('CheckReleaseAudit0 reports the concrete final-certificate public-status gate summary', async () => {
  ...
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0Accepted, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0Checker, 'CheckConcreteMaterializedHard0');
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0Digest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0MaterializedHardDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0HardCheckDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0CoverageDigest.hex, /^[0-9a-f]{64}$/);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0CheckerCount, 13);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0CheckerCoverageComplete, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0RowKeyFieldCount, 17);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0RowKeyCoverageComplete, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0RoutePriorityComplete, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0ProofRefPolicyComplete, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0HashDisciplineComplete, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0NoMinCoverageComplete, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0ForbiddenSymbolCount, 11);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0ImportPolicyComplete, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0ForbiddenImportEdgeCount, 6);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0ReflectionPolicyComplete, true);
  ...
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0Accepted, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0Checker, 'CheckConcreteMaterializedGlobalProofDAG0');
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0Digest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0GlobalProofDAGDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0GlobalProofDAGObjectDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0MaterializedGlobalProofDAGDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0KImplDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0RowPackDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0LocalPackagesDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0GlobalFirewallsDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0KBundleProofInventoryDigest.hex, /^[0-9a-f]{64}$/);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0KBundleKernelRuleCoverageComplete, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0KBundleSigmaProofRefsResolve, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0KBundleReflectionProofRefsResolve, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0NodeCount >= 90, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0NodeCountMinimum, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0FinalTheoremCount, 4);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0FinalPackageSoundness, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0FinalGeneratedPackageSufficiency, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0FinalAcceptedPackageImpliesSATinP, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0FinalAcceptedPackageImpliesPEqualsNP, true);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0IfaceHash.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0SchedHash.hex, /^[0-9a-f]{64}$/);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0IfaceMatchesRows, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0SchedMatchesKImpl, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0ForbiddenMarkerCount, 0);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0NoForbiddenMarkers, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0LinkedToGeneratedBoot0, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0LinkedToKImpl, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0LinkedToConcreteRows, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0LinkedToLocalPackages, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0LinkedToGlobalFirewalls, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0LinkedToPCCPack, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0Accepted, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0Checker, 'CheckConcreteMaterializedFinalIntegration0');
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0Digest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0ConcreteGlobalProofDAGDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0MaterializedFinalIntegrationDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0GPackDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0RowFamGDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0FinalIntegrationDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0FinalTheoremDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0RowFamFinalDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0ConcreteLinksDigest.hex, /^[0-9a-f]{64}$/);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0ConcreteGlobalProofDAG, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0ConcreteKBundle, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0ConcreteRows, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0ConcreteLocalPackages, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0ConcreteGlobalFirewalls, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0KBundleKernelRuleCoverageComplete, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0KBundleSigmaProofRefsResolve, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0KBundleReflectionProofRefsResolve, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0GPackFieldCoverageComplete, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0RowFamGCoverageComplete, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0FinalIntegrationUsesGPack, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0RowFamGUsesGPack, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0FinalTheoremUsesFinalIntegration, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0RowFamFinalUsesFinalTheorem, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0FinalMatchUsesGPack, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0SATDecisionUsesGPack, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0ForbiddenMarkerCount, 0);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0NoForbiddenMarkers, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0LinkedToGeneratedGlobalProofDAG, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0LinkedToGPack, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0LinkedToRowFamG, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0LinkedToFinalIntegration, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0LinkedToFinalTheorem, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0LinkedToRowFamFinal, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0LinkedToPCCPack, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0Accepted, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0Checker, 'CheckPCCPackexp0');
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0Digest.hex, /^[0-9a-f]{64}$/);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0MaterializedPath, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0SyntheticRunAll, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0PackageKind, 'PCCPack0');
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0PCCPackDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0MaterializedPCCPackDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcretePCCPackRecordDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcreteCoverageDigest.hex, /^[0-9a-f]{64}$/);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0PublicConclusionOnlyAfterAcceptRun, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0PublicConclusionEmitted, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0NoPrematurePublicConclusion, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ClaimBoundaryConditional, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ClaimBoundaryAntecedent, 'CheckPCCPackexp(GeneratePCCPack())=accept');
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ClaimBoundaryConsequent, 'P = NP');
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0GeneratedPackageImplication, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcretePCCPack, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcreteKBundle, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcreteHardCheck, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcreteRows, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcreteLocalPackages, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcreteGlobalFirewalls, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcreteGlobalProofDAG, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcreteFinalIntegration, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0KBundleCoverageComplete, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0HardCoverageComplete, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0FinalIntegrationCoverageComplete, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0PCCPackLinkageComplete, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcreteCoverageComplete, true);
  assert.equal(out.NF.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcretePCCPackRecordAccepted, true);
  ...
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0Accepted, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0Checker, 'CheckConcreteMaterializedHard0');
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0Digest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0MaterializedHardDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0HardCheckDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0CoverageDigest.hex, /^[0-9a-f]{64}$/);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0CheckerCount, 13);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0CheckerCoverageComplete, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0RowKeyFieldCount, 17);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0RowKeyCoverageComplete, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0RoutePriorityComplete, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0ProofRefPolicyComplete, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0HashDisciplineComplete, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0NoMinCoverageComplete, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0ForbiddenSymbolCount, 11);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0ImportPolicyComplete, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0ForbiddenImportEdgeCount, 6);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteHard0ReflectionPolicyComplete, true);
  ...
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0Accepted, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0Checker, 'CheckConcreteMaterializedGlobalProofDAG0');
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0Digest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0GlobalProofDAGDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0GlobalProofDAGObjectDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0MaterializedGlobalProofDAGDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0KImplDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0RowPackDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0LocalPackagesDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0GlobalFirewallsDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0KBundleProofInventoryDigest.hex, /^[0-9a-f]{64}$/);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0KBundleKernelRuleCoverageComplete, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0KBundleSigmaProofRefsResolve, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0KBundleReflectionProofRefsResolve, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0NodeCount >= 90, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0NodeCountMinimum, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0FinalTheoremCount, 4);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0FinalPackageSoundness, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0FinalGeneratedPackageSufficiency, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0FinalAcceptedPackageImpliesSATinP, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0FinalAcceptedPackageImpliesPEqualsNP, true);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0IfaceHash.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0SchedHash.hex, /^[0-9a-f]{64}$/);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0IfaceMatchesRows, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0SchedMatchesKImpl, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0ForbiddenMarkerCount, 0);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0NoForbiddenMarkers, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0LinkedToGeneratedBoot0, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0LinkedToKImpl, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0LinkedToConcreteRows, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0LinkedToLocalPackages, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0LinkedToGlobalFirewalls, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteGlobalProofDAG0LinkedToPCCPack, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0Accepted, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0Checker, 'CheckConcreteMaterializedFinalIntegration0');
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0Digest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0ConcreteGlobalProofDAGDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0MaterializedFinalIntegrationDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0GPackDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0RowFamGDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0FinalIntegrationDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0FinalTheoremDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0RowFamFinalDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0ConcreteLinksDigest.hex, /^[0-9a-f]{64}$/);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0ConcreteGlobalProofDAG, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0ConcreteKBundle, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0ConcreteRows, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0ConcreteLocalPackages, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0ConcreteGlobalFirewalls, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0KBundleKernelRuleCoverageComplete, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0KBundleSigmaProofRefsResolve, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0KBundleReflectionProofRefsResolve, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0GPackFieldCoverageComplete, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0RowFamGCoverageComplete, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0FinalIntegrationUsesGPack, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0RowFamGUsesGPack, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0FinalTheoremUsesFinalIntegration, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0RowFamFinalUsesFinalTheorem, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0FinalMatchUsesGPack, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0SATDecisionUsesGPack, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0ForbiddenMarkerCount, 0);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0NoForbiddenMarkers, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0LinkedToGeneratedGlobalProofDAG, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0LinkedToGPack, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0LinkedToRowFamG, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0LinkedToFinalIntegration, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0LinkedToFinalTheorem, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0LinkedToRowFamFinal, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpConcreteFinalIntegration0LinkedToPCCPack, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0Accepted, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0Checker, 'CheckPCCPackexp0');
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0Digest.hex, /^[0-9a-f]{64}$/);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0MaterializedPath, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0SyntheticRunAll, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0PackageKind, 'PCCPack0');
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0PCCPackDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0MaterializedPCCPackDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcretePCCPackRecordDigest.hex, /^[0-9a-f]{64}$/);
  assert.match(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcreteCoverageDigest.hex, /^[0-9a-f]{64}$/);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0PublicConclusionOnlyAfterAcceptRun, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0PublicConclusionEmitted, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0NoPrematurePublicConclusion, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ClaimBoundaryConditional, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ClaimBoundaryAntecedent, 'CheckPCCPackexp(GeneratePCCPack())=accept');
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ClaimBoundaryConsequent, 'P = NP');
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0GeneratedPackageImplication, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcretePCCPack, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcreteKBundle, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcreteHardCheck, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcreteRows, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcreteLocalPackages, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcreteGlobalFirewalls, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcreteGlobalProofDAG, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcreteFinalIntegration, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0KBundleCoverageComplete, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0HardCoverageComplete, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0FinalIntegrationCoverageComplete, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0PCCPackLinkageComplete, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcreteCoverageComplete, true);
  assert.equal(summary.concreteFinalCertificatePublicStatusGateGeneratedPCCPackexpCheckPCCPackexp0ConcretePCCPackRecordAccepted, true);
...
test('CheckReleaseAudit0 rejects a concrete final-certificate gate without concrete HardCheck no-min evidence', async () => {
  const bad = makeAcceptedConcreteFinalCertificatePublicStatusRecord0();
...
test('CheckReleaseAudit0 rejects a concrete final-certificate gate without concrete HardCheck proof-ref evidence', async () => {
  const bad = makeAcceptedConcreteFinalCertificatePublicStatusRecord0();
...
test('CheckReleaseAudit0 rejects a concrete final-certificate gate without concrete GlobalProofDAG final theorem evidence', async () => {
  const bad = makeAcceptedConcreteFinalCertificatePublicStatusRecord0();
...
test('CheckReleaseAudit0 rejects a concrete final-certificate gate without concrete GlobalProofDAG linkage evidence', async () => {
  const bad = makeAcceptedConcreteFinalCertificatePublicStatusRecord0();
...
test('CheckReleaseAudit0 rejects a concrete final-certificate gate without concrete FinalIntegration SATDecision evidence', async () => {
  const bad = makeAcceptedConcreteFinalCertificatePublicStatusRecord0();
...
test('CheckReleaseAudit0 rejects a concrete final-certificate gate without concrete FinalIntegration PCCPack linkage evidence', async () => {
  const bad = makeAcceptedConcreteFinalCertificatePublicStatusRecord0();
...
test('CheckReleaseAudit0 rejects a concrete final-certificate gate without CheckPCCPackexp0 implication evidence', async () => {
  const bad = makeAcceptedConcreteFinalCertificatePublicStatusRecord0();
...
test('CheckReleaseAudit0 rejects a concrete final-certificate gate without CheckPCCPackexp0 concrete coverage evidence', async () => {
  const bad = makeAcceptedConcreteFinalCertificatePublicStatusRecord0();
